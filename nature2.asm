...
_nature2:     file format elf32-i386
...
int main() {
	...
	printf(1,"Hydrogen count should be 1, and oxygen count should be 0, therefore water should be 0, or infinite loop. \n"); 
    ...
    1064:	00 
    1065:	c7 04 24 4e 11 00 00 	movl   $0x114e,(%esp)
