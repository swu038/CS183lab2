...
main(void)
{
  ...
  10:	00 
  11:	c7 04 24 2c 0c 00 00 	movl   $0xc2c,(%esp)
  ...
  30:	00 
  31:	c7 04 24 2c 0c 00 00 	movl   $0xc2c,(%esp)
  38:	e8 87 03 00 00       	call   3c4 <mknod>
    open("console", O_RDWR);
  3d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  44:	00 
  45:	c7 04 24 2c 0c 00 00 	movl   $0xc2c,(%esp)
  ...
  6c:	c7 44 24 04 34 0c 00 	movl   $0xc34,0x4(%esp)
  73:	00 
  ...
  90:	c7 44 24 04 47 0c 00 	movl   $0xc47,0x4(%esp)
  97:	00 
  ...
  ae:	75 43                	jne    f3 <main+0xf3>
      exec("sh", argv);
  b0:	c7 44 24 04 ac 0c 00 	movl   $0xcac,0x4(%esp)
  b7:	00 
  b8:	c7 04 24 29 0c 00 00 	movl   $0xc29,(%esp)
  bf:	e8 f0 02 00 00       	call   3b4 <exec>
      printf(1, "init: exec sh failed\n");
  c4:	c7 44 24 04 5a 0c 00 	movl   $0xc5a,0x4(%esp)
  cb:	00 
  ...
  d8:	e8 9f 02 00 00       	call   37c <exit>
    ...
    while((wpid=wait()) >= 0 && wpid != pid)
      printf(1, "zombie!\n");
  dd:	c7 44 24 04 70 0c 00 	movl   $0xc70,0x4(%esp)
  e4:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ae:	0f b6 80 b4 0c 00 00 	movzbl 0xcb4(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 60c:	75 27                	jne    635 <printf+0x120>
          s = "(null)";
 60e:	c7 45 e4 79 0c 00 00 	movl   $0xc79,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6db:	a1 d4 0c 00 00       	mov    0xcd4,%eax
...
free(void *ap)
{
 ...
 79c:	a3 d4 0c 00 00       	mov    %eax,0xcd4
}
 7a1:	c9                   	leave  
 7a2:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7ef:	e8 d8 fe ff ff       	call   6cc <free>
  return freep;
 7f4:	a1 d4 0c 00 00       	mov    0xcd4,%eax
}
 7f9:	c9                   	leave  
 7fa:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 80d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 810:	a1 d4 0c 00 00       	mov    0xcd4,%eax
 815:	89 45 f0             	mov    %eax,-0x10(%ebp)
 818:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 81c:	75 23                	jne    841 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 81e:	c7 45 f0 cc 0c 00 00 	movl   $0xccc,-0x10(%ebp)
 825:	8b 45 f0             	mov    -0x10(%ebp),%eax
 828:	a3 d4 0c 00 00       	mov    %eax,0xcd4
 82d:	a1 d4 0c 00 00       	mov    0xcd4,%eax
 832:	a3 cc 0c 00 00       	mov    %eax,0xccc
    base.s.size = 0;
 837:	c7 05 d0 0c 00 00 00 	movl   $0x0,0xcd0
 83e:	00 00 00 
  }
 ...
 894:	a3 d4 0c 00 00       	mov    %eax,0xcd4
      return (void*)(p + 1);
 ...
 89f:	eb 38                	jmp    8d9 <malloc+0xde>
    ...
    if(p == freep)
 8a1:	a1 d4 0c 00 00       	mov    0xcd4,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 980:	c7 44 24 04 80 0c 00 	movl   $0xc80,0x4(%esp)
 987:	00 
 ...
 9c5:	c7 44 24 04 8e 0c 00 	movl   $0xc8e,0x4(%esp)
 9cc:	00 
 ...
 9f1:	c7 44 24 04 9b 0c 00 	movl   $0xc9b,0x4(%esp)
 9f8:	00 
...
int random(int max){
 ...
 a0f:	a1 c8 0c 00 00       	mov    0xcc8,%eax
 a14:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 a1a:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 a1f:	a3 c8 0c 00 00       	mov    %eax,0xcc8
    return (int)(rands % max);
 a24:	a1 c8 0c 00 00       	mov    0xcc8,%eax
...
void sem_acquire(struct Semaphore *s) 
{
 ...
 b5c:	e8 a3 fd ff ff       	call   904 <lock_acquire>
	if( s->count-- < 0) 
 b61:	8b 45 08             	mov    0x8(%ebp),%eax
 b64:	8b 40 04             	mov    0x4(%eax),%eax
 b67:	89 c2                	mov    %eax,%edx
 b69:	c1 ea 1f             	shr    $0x1f,%edx
 b6c:	8d 48 ff             	lea    -0x1(%eax),%ecx
 b6f:	8b 45 08             	mov    0x8(%ebp),%eax
 b72:	89 48 04             	mov    %ecx,0x4(%eax)
 b75:	84 d2                	test   %dl,%dl
 b77:	74 27                	je     ba0 <sem_acquire+0x50>
	{
		add_q(&s->q, getpid()); 
 b79:	e8 7e f8 ff ff       	call   3fc <getpid>
 b7e:	8b 55 08             	mov    0x8(%ebp),%edx
 b81:	83 c2 08             	add    $0x8,%edx
 b84:	89 44 24 04          	mov    %eax,0x4(%esp)
 b88:	89 14 24             	mov    %edx,(%esp)
 b8b:	e8 ca fe ff ff       	call   a5a <add_q>
		lock_release(&s->lock); 
 b90:	8b 45 08             	mov    0x8(%ebp),%eax
 b93:	89 04 24             	mov    %eax,(%esp)
 b96:	e8 88 fd ff ff       	call   923 <lock_release>
		tsleep(); 
 b9b:	e8 8c f8 ff ff       	call   42c <tsleep>
	} 
	lock_release(&s->lock); 
 ba0:	8b 45 08             	mov    0x8(%ebp),%eax
 ba3:	89 04 24             	mov    %eax,(%esp)
 ba6:	e8 78 fd ff ff       	call   923 <lock_release>
}
 bab:	c9                   	leave  
 bac:	c3                   	ret    
...
void sem_init(struct Semaphore *s, int size){
 ...
 c0b:	e8 e6 fc ff ff       	call   8f6 <lock_init>
	s->count = size; 
 c10:	8b 45 08             	mov    0x8(%ebp),%eax
 c13:	8b 55 0c             	mov    0xc(%ebp),%edx
 c16:	89 50 04             	mov    %edx,0x4(%eax)
	init_q(&s->q);
 c19:	8b 45 08             	mov    0x8(%ebp),%eax
 c1c:	83 c0 08             	add    $0x8,%eax
 c1f:	89 04 24             	mov    %eax,(%esp)
 c22:	e8 11 fe ff ff       	call   a38 <init_q>
}
 c27:	c9                   	leave  
 c28:	c3                   	ret    
