...
int main(){
  ...
  61:	c7 44 24 04 9d 0b 00 	movl   $0xb9d,0x4(%esp)
  68:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 422:	0f b6 80 d8 0b 00 00 	movzbl 0xbd8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 580:	75 27                	jne    5a9 <printf+0x120>
          s = "(null)";
 582:	c7 45 e4 a5 0b 00 00 	movl   $0xba5,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 64f:	a1 f8 0b 00 00       	mov    0xbf8,%eax
...
free(void *ap)
{
 ...
 710:	a3 f8 0b 00 00       	mov    %eax,0xbf8
}
 715:	c9                   	leave  
 716:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 781:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 784:	a1 f8 0b 00 00       	mov    0xbf8,%eax
 789:	89 45 f0             	mov    %eax,-0x10(%ebp)
 78c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 790:	75 23                	jne    7b5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 792:	c7 45 f0 f0 0b 00 00 	movl   $0xbf0,-0x10(%ebp)
 799:	8b 45 f0             	mov    -0x10(%ebp),%eax
 79c:	a3 f8 0b 00 00       	mov    %eax,0xbf8
 7a1:	a1 f8 0b 00 00       	mov    0xbf8,%eax
 7a6:	a3 f0 0b 00 00       	mov    %eax,0xbf0
    base.s.size = 0;
 7ab:	c7 05 f4 0b 00 00 00 	movl   $0x0,0xbf4
 7b2:	00 00 00 
  }
 ...
 808:	a3 f8 0b 00 00       	mov    %eax,0xbf8
      return (void*)(p + 1);
 ...
 813:	eb 38                	jmp    84d <malloc+0xde>
    ...
    if(p == freep)
 815:	a1 f8 0b 00 00       	mov    0xbf8,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8f4:	c7 44 24 04 ac 0b 00 	movl   $0xbac,0x4(%esp)
 8fb:	00 
 ...
 939:	c7 44 24 04 ba 0b 00 	movl   $0xbba,0x4(%esp)
 940:	00 
 ...
 965:	c7 44 24 04 c7 0b 00 	movl   $0xbc7,0x4(%esp)
 96c:	00 
...
int random(int max){
 ...
 983:	a1 ec 0b 00 00       	mov    0xbec,%eax
 988:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 98e:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 993:	a3 ec 0b 00 00       	mov    %eax,0xbec
    return (int)(rands % max);
 998:	a1 ec 0b 00 00       	mov    0xbec,%eax
...
void sem_acquire(struct Semaphore *s) 
{
 ...
 ad0:	e8 a3 fd ff ff       	call   878 <lock_acquire>
	if( s->count-- < 0) 
 ad5:	8b 45 08             	mov    0x8(%ebp),%eax
 ad8:	8b 40 04             	mov    0x4(%eax),%eax
 adb:	89 c2                	mov    %eax,%edx
 add:	c1 ea 1f             	shr    $0x1f,%edx
 ae0:	8d 48 ff             	lea    -0x1(%eax),%ecx
 ae3:	8b 45 08             	mov    0x8(%ebp),%eax
 ae6:	89 48 04             	mov    %ecx,0x4(%eax)
 ae9:	84 d2                	test   %dl,%dl
 aeb:	74 27                	je     b14 <sem_acquire+0x50>
	{
		add_q(&s->q, getpid()); 
 aed:	e8 7e f8 ff ff       	call   370 <getpid>
 af2:	8b 55 08             	mov    0x8(%ebp),%edx
 af5:	83 c2 08             	add    $0x8,%edx
 af8:	89 44 24 04          	mov    %eax,0x4(%esp)
 afc:	89 14 24             	mov    %edx,(%esp)
 aff:	e8 ca fe ff ff       	call   9ce <add_q>
		lock_release(&s->lock); 
 b04:	8b 45 08             	mov    0x8(%ebp),%eax
 b07:	89 04 24             	mov    %eax,(%esp)
 b0a:	e8 88 fd ff ff       	call   897 <lock_release>
		tsleep(); 
 b0f:	e8 8c f8 ff ff       	call   3a0 <tsleep>
	} 
	lock_release(&s->lock); 
 b14:	8b 45 08             	mov    0x8(%ebp),%eax
 b17:	89 04 24             	mov    %eax,(%esp)
 b1a:	e8 78 fd ff ff       	call   897 <lock_release>
}
 b1f:	c9                   	leave  
 b20:	c3                   	ret    
