...
wc(int fd, char *name)
{
  ...
  52:	c7 04 24 d5 0c 00 00 	movl   $0xcd5,(%esp)
  ...
  b6:	c7 44 24 04 db 0c 00 	movl   $0xcdb,0x4(%esp)
  bd:	00 
  ...
  eb:	c7 44 24 04 eb 0c 00 	movl   $0xceb,0x4(%esp)
  f2:	00 
...
main(int argc, char *argv[])
{
 ...
 10e:	7f 19                	jg     129 <main+0x28>
    wc(0, "");
 110:	c7 44 24 04 f8 0c 00 	movl   $0xcf8,0x4(%esp)
 117:	00 
 ...
 16a:	c7 44 24 04 f9 0c 00 	movl   $0xcf9,0x4(%esp)
 171:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 55a:	0f b6 80 40 0d 00 00 	movzbl 0xd40(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 6b8:	75 27                	jne    6e1 <printf+0x120>
          s = "(null)";
 6ba:	c7 45 e4 0d 0d 00 00 	movl   $0xd0d,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 787:	a1 68 0d 00 00       	mov    0xd68,%eax
...
free(void *ap)
{
 ...
 848:	a3 68 0d 00 00       	mov    %eax,0xd68
}
 84d:	c9                   	leave  
 84e:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 89b:	e8 d8 fe ff ff       	call   778 <free>
  return freep;
 8a0:	a1 68 0d 00 00       	mov    0xd68,%eax
}
 8a5:	c9                   	leave  
 8a6:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8b9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 8bc:	a1 68 0d 00 00       	mov    0xd68,%eax
 8c1:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8c4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8c8:	75 23                	jne    8ed <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8ca:	c7 45 f0 60 0d 00 00 	movl   $0xd60,-0x10(%ebp)
 8d1:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8d4:	a3 68 0d 00 00       	mov    %eax,0xd68
 8d9:	a1 68 0d 00 00       	mov    0xd68,%eax
 8de:	a3 60 0d 00 00       	mov    %eax,0xd60
    base.s.size = 0;
 8e3:	c7 05 64 0d 00 00 00 	movl   $0x0,0xd64
 8ea:	00 00 00 
  }
 ...
 940:	a3 68 0d 00 00       	mov    %eax,0xd68
      return (void*)(p + 1);
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 a2c:	c7 44 24 04 14 0d 00 	movl   $0xd14,0x4(%esp)
 a33:	00 
 ...
 a71:	c7 44 24 04 22 0d 00 	movl   $0xd22,0x4(%esp)
 a78:	00 
 ...
 a9d:	c7 44 24 04 2f 0d 00 	movl   $0xd2f,0x4(%esp)
 aa4:	00 
...
int random(int max){
 ...
 abb:	a1 54 0d 00 00       	mov    0xd54,%eax
 ac0:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 ac6:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 acb:	a3 54 0d 00 00       	mov    %eax,0xd54
    return (int)(rands % max);
 ad0:	a1 54 0d 00 00       	mov    0xd54,%eax
...
void sem_acquire(struct Semaphore *s) 
{
 ...
 c08:	e8 a3 fd ff ff       	call   9b0 <lock_acquire>
	if( s->count-- < 0) 
 c0d:	8b 45 08             	mov    0x8(%ebp),%eax
 c10:	8b 40 04             	mov    0x4(%eax),%eax
 c13:	89 c2                	mov    %eax,%edx
 c15:	c1 ea 1f             	shr    $0x1f,%edx
 c18:	8d 48 ff             	lea    -0x1(%eax),%ecx
 c1b:	8b 45 08             	mov    0x8(%ebp),%eax
 c1e:	89 48 04             	mov    %ecx,0x4(%eax)
 c21:	84 d2                	test   %dl,%dl
 c23:	74 27                	je     c4c <sem_acquire+0x50>
	{
		add_q(&s->q, getpid()); 
 c25:	e8 7e f8 ff ff       	call   4a8 <getpid>
 c2a:	8b 55 08             	mov    0x8(%ebp),%edx
 c2d:	83 c2 08             	add    $0x8,%edx
 c30:	89 44 24 04          	mov    %eax,0x4(%esp)
 c34:	89 14 24             	mov    %edx,(%esp)
 c37:	e8 ca fe ff ff       	call   b06 <add_q>
		lock_release(&s->lock); 
 c3c:	8b 45 08             	mov    0x8(%ebp),%eax
 c3f:	89 04 24             	mov    %eax,(%esp)
 c42:	e8 88 fd ff ff       	call   9cf <lock_release>
		tsleep(); 
 c47:	e8 8c f8 ff ff       	call   4d8 <tsleep>
	} 
	lock_release(&s->lock); 
 c4c:	8b 45 08             	mov    0x8(%ebp),%eax
 c4f:	89 04 24             	mov    %eax,(%esp)
 c52:	e8 78 fd ff ff       	call   9cf <lock_release>
}
 c57:	c9                   	leave  
 c58:	c3                   	ret    
