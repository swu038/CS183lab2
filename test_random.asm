...
int main(){
  ...
  19:	c7 44 24 04 d5 0b 00 	movl   $0xbd5,0x4(%esp)
  20:	00 
  ...
  3d:	c7 44 24 04 d5 0b 00 	movl   $0xbd5,0x4(%esp)
  44:	00 
  ...
  61:	c7 44 24 04 d5 0b 00 	movl   $0xbd5,0x4(%esp)
  68:	00 
  ...
  85:	c7 44 24 04 d5 0b 00 	movl   $0xbd5,0x4(%esp)
  8c:	00 
  ...
  a9:	c7 44 24 04 d5 0b 00 	movl   $0xbd5,0x4(%esp)
  b0:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45a:	0f b6 80 1c 0c 00 00 	movzbl 0xc1c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5b8:	75 27                	jne    5e1 <printf+0x120>
          s = "(null)";
 5ba:	c7 45 e4 e7 0b 00 00 	movl   $0xbe7,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 687:	a1 3c 0c 00 00       	mov    0xc3c,%eax
...
free(void *ap)
{
 ...
 748:	a3 3c 0c 00 00       	mov    %eax,0xc3c
}
 74d:	c9                   	leave  
 74e:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 79b:	e8 d8 fe ff ff       	call   678 <free>
  return freep;
 7a0:	a1 3c 0c 00 00       	mov    0xc3c,%eax
}
 7a5:	c9                   	leave  
 7a6:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7b9:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 7bc:	a1 3c 0c 00 00       	mov    0xc3c,%eax
 7c1:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7c4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7c8:	75 23                	jne    7ed <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7ca:	c7 45 f0 34 0c 00 00 	movl   $0xc34,-0x10(%ebp)
 7d1:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7d4:	a3 3c 0c 00 00       	mov    %eax,0xc3c
 7d9:	a1 3c 0c 00 00       	mov    0xc3c,%eax
 7de:	a3 34 0c 00 00       	mov    %eax,0xc34
    base.s.size = 0;
 7e3:	c7 05 38 0c 00 00 00 	movl   $0x0,0xc38
 7ea:	00 00 00 
  }
 ...
 840:	a3 3c 0c 00 00       	mov    %eax,0xc3c
      return (void*)(p + 1);
 ...
 84b:	eb 38                	jmp    885 <malloc+0xde>
    ...
    if(p == freep)
 84d:	a1 3c 0c 00 00       	mov    0xc3c,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 92c:	c7 44 24 04 ee 0b 00 	movl   $0xbee,0x4(%esp)
 933:	00 
 ...
 971:	c7 44 24 04 fc 0b 00 	movl   $0xbfc,0x4(%esp)
 978:	00 
 ...
 99d:	c7 44 24 04 09 0c 00 	movl   $0xc09,0x4(%esp)
 9a4:	00 
...
int random(int max){
 ...
 9bb:	a1 30 0c 00 00       	mov    0xc30,%eax
 9c0:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 9c6:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 9cb:	a3 30 0c 00 00       	mov    %eax,0xc30
    return (int)(rands % max);
 9d0:	a1 30 0c 00 00       	mov    0xc30,%eax
...
void sem_acquire(struct Semaphore *s) 
{
 ...
 aff:	83 ec 18             	sub    $0x18,%esp
	lock_acquire(&s->lock); 
 b02:	8b 45 08             	mov    0x8(%ebp),%eax
 b05:	89 04 24             	mov    %eax,(%esp)
 b08:	e8 a3 fd ff ff       	call   8b0 <lock_acquire>
	if( s->count-- < 0) 
 b0d:	8b 45 08             	mov    0x8(%ebp),%eax
 b10:	8b 40 04             	mov    0x4(%eax),%eax
 b13:	89 c2                	mov    %eax,%edx
 b15:	c1 ea 1f             	shr    $0x1f,%edx
 b18:	8d 48 ff             	lea    -0x1(%eax),%ecx
 b1b:	8b 45 08             	mov    0x8(%ebp),%eax
 b1e:	89 48 04             	mov    %ecx,0x4(%eax)
 b21:	84 d2                	test   %dl,%dl
 b23:	74 27                	je     b4c <sem_acquire+0x50>
	{
		add_q(&s->q, getpid()); 
 b25:	e8 7e f8 ff ff       	call   3a8 <getpid>
 b2a:	8b 55 08             	mov    0x8(%ebp),%edx
 b2d:	83 c2 08             	add    $0x8,%edx
 b30:	89 44 24 04          	mov    %eax,0x4(%esp)
 b34:	89 14 24             	mov    %edx,(%esp)
 b37:	e8 ca fe ff ff       	call   a06 <add_q>
		lock_release(&s->lock); 
 b3c:	8b 45 08             	mov    0x8(%ebp),%eax
 b3f:	89 04 24             	mov    %eax,(%esp)
 b42:	e8 88 fd ff ff       	call   8cf <lock_release>
		tsleep(); 
 b47:	e8 8c f8 ff ff       	call   3d8 <tsleep>
	} 
	lock_release(&s->lock); 
 b4c:	8b 45 08             	mov    0x8(%ebp),%eax
 b4f:	89 04 24             	mov    %eax,(%esp)
 b52:	e8 78 fd ff ff       	call   8cf <lock_release>
}
 b57:	c9                   	leave  
 b58:	c3                   	ret    
...
void sem_init(struct Semaphore *s, int size){
 ...
 bb7:	e8 e6 fc ff ff       	call   8a2 <lock_init>
	s->count = size; 
 ...
 bce:	e8 11 fe ff ff       	call   9e4 <init_q>
}
 bd3:	c9                   	leave  
 bd4:	c3                   	ret    
