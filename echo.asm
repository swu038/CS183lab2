...
main(int argc, char *argv[])
{
  ...
  1f:	b8 79 0b 00 00       	mov    $0xb79,%eax
  24:	eb 05                	jmp    2b <main+0x2b>
  26:	b8 7b 0b 00 00       	mov    $0xb7b,%eax
  ...
  3f:	c7 44 24 04 7d 0b 00 	movl   $0xb7d,0x4(%esp)
  46:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fe:	0f b6 80 b8 0b 00 00 	movzbl 0xbb8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 55c:	75 27                	jne    585 <printf+0x120>
          s = "(null)";
 55e:	c7 45 e4 82 0b 00 00 	movl   $0xb82,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 62b:	a1 d8 0b 00 00       	mov    0xbd8,%eax
...
free(void *ap)
{
 ...
 6ec:	a3 d8 0b 00 00       	mov    %eax,0xbd8
}
 6f1:	c9                   	leave  
 6f2:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 73f:	e8 d8 fe ff ff       	call   61c <free>
  return freep;
 744:	a1 d8 0b 00 00       	mov    0xbd8,%eax
}
 749:	c9                   	leave  
 74a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 75d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 760:	a1 d8 0b 00 00       	mov    0xbd8,%eax
 765:	89 45 f0             	mov    %eax,-0x10(%ebp)
 768:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 76c:	75 23                	jne    791 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 76e:	c7 45 f0 d0 0b 00 00 	movl   $0xbd0,-0x10(%ebp)
 775:	8b 45 f0             	mov    -0x10(%ebp),%eax
 778:	a3 d8 0b 00 00       	mov    %eax,0xbd8
 77d:	a1 d8 0b 00 00       	mov    0xbd8,%eax
 782:	a3 d0 0b 00 00       	mov    %eax,0xbd0
    base.s.size = 0;
 787:	c7 05 d4 0b 00 00 00 	movl   $0x0,0xbd4
 78e:	00 00 00 
  }
 ...
 7e4:	a3 d8 0b 00 00       	mov    %eax,0xbd8
      return (void*)(p + 1);
 ...
 7ef:	eb 38                	jmp    829 <malloc+0xde>
    ...
    if(p == freep)
 7f1:	a1 d8 0b 00 00       	mov    0xbd8,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8d0:	c7 44 24 04 89 0b 00 	movl   $0xb89,0x4(%esp)
 8d7:	00 
 ...
 915:	c7 44 24 04 97 0b 00 	movl   $0xb97,0x4(%esp)
 91c:	00 
 ...
 941:	c7 44 24 04 a4 0b 00 	movl   $0xba4,0x4(%esp)
 948:	00 
...
int random(int max){
 ...
 95f:	a1 cc 0b 00 00       	mov    0xbcc,%eax
 964:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 96a:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 96f:	a3 cc 0b 00 00       	mov    %eax,0xbcc
    return (int)(rands % max);
 974:	a1 cc 0b 00 00       	mov    0xbcc,%eax
...
void sem_acquire(struct Semaphore *s) 
{
 ...
 aac:	e8 a3 fd ff ff       	call   854 <lock_acquire>
	if( s->count-- < 0) 
 ab1:	8b 45 08             	mov    0x8(%ebp),%eax
 ab4:	8b 40 04             	mov    0x4(%eax),%eax
 ab7:	89 c2                	mov    %eax,%edx
 ab9:	c1 ea 1f             	shr    $0x1f,%edx
 abc:	8d 48 ff             	lea    -0x1(%eax),%ecx
 abf:	8b 45 08             	mov    0x8(%ebp),%eax
 ac2:	89 48 04             	mov    %ecx,0x4(%eax)
 ac5:	84 d2                	test   %dl,%dl
 ac7:	74 27                	je     af0 <sem_acquire+0x50>
	{
		add_q(&s->q, getpid()); 
 ac9:	e8 7e f8 ff ff       	call   34c <getpid>
 ace:	8b 55 08             	mov    0x8(%ebp),%edx
 ad1:	83 c2 08             	add    $0x8,%edx
 ad4:	89 44 24 04          	mov    %eax,0x4(%esp)
 ad8:	89 14 24             	mov    %edx,(%esp)
 adb:	e8 ca fe ff ff       	call   9aa <add_q>
		lock_release(&s->lock); 
 ae0:	8b 45 08             	mov    0x8(%ebp),%eax
 ae3:	89 04 24             	mov    %eax,(%esp)
 ae6:	e8 88 fd ff ff       	call   873 <lock_release>
		tsleep(); 
 aeb:	e8 8c f8 ff ff       	call   37c <tsleep>
	} 
	lock_release(&s->lock); 
 af0:	8b 45 08             	mov    0x8(%ebp),%eax
 af3:	89 04 24             	mov    %eax,(%esp)
 af6:	e8 78 fd ff ff       	call   873 <lock_release>
}
 afb:	c9                   	leave  
 afc:	c3                   	ret    
...
void sem_init(struct Semaphore *s, int size){
 ...
 b5b:	e8 e6 fc ff ff       	call   846 <lock_init>
	s->count = size; 
 ...
 b72:	e8 11 fe ff ff       	call   988 <init_q>
}
 b77:	c9                   	leave  
 b78:	c3                   	ret    
