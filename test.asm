...
int main(int argc, char *argv[]){
   ...
   9:	c7 44 24 04 f1 0b 00 	movl   $0xbf1,0x4(%esp)
  10:	00 
  11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  18:	e8 c0 04 00 00       	call   4dd <printf>

   printf(1,"before thread_create n = %d\n",n);
  1d:	a1 98 0c 00 00       	mov    0xc98,%eax
  22:	89 44 24 08          	mov    %eax,0x8(%esp)
  26:	c7 44 24 04 0c 0c 00 	movl   $0xc0c,0x4(%esp)
  2d:	00 
  ...
  61:	c7 44 24 04 29 0c 00 	movl   $0xc29,0x4(%esp)
  68:	00 
  ...
  75:	e8 ca 02 00 00       	call   344 <exit>
   ...
   while(wait()>= 0)
   printf(1,"\nback to parent n = %d\n",n);
  7a:	a1 98 0c 00 00       	mov    0xc98,%eax
  7f:	89 44 24 08          	mov    %eax,0x8(%esp)
  83:	c7 44 24 04 36 0c 00 	movl   $0xc36,0x4(%esp)
  8a:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 476:	0f b6 80 9c 0c 00 00 	movzbl 0xc9c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5d4:	75 27                	jne    5fd <printf+0x120>
          s = "(null)";
 5d6:	c7 45 e4 64 0c 00 00 	movl   $0xc64,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a3:	a1 bc 0c 00 00       	mov    0xcbc,%eax
...
malloc(uint nbytes)
{
 ...
 7d5:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 7d8:	a1 bc 0c 00 00       	mov    0xcbc,%eax
 7dd:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7e0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7e4:	75 23                	jne    809 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7e6:	c7 45 f0 b4 0c 00 00 	movl   $0xcb4,-0x10(%ebp)
 7ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7f0:	a3 bc 0c 00 00       	mov    %eax,0xcbc
 7f5:	a1 bc 0c 00 00       	mov    0xcbc,%eax
 7fa:	a3 b4 0c 00 00       	mov    %eax,0xcb4
    base.s.size = 0;
 7ff:	c7 05 b8 0c 00 00 00 	movl   $0x0,0xcb8
 806:	00 00 00 
  }
 ...
 85c:	a3 bc 0c 00 00       	mov    %eax,0xcbc
      return (void*)(p + 1);
 ...
 867:	eb 38                	jmp    8a1 <malloc+0xde>
    ...
    if(p == freep)
 869:	a1 bc 0c 00 00       	mov    0xcbc,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 948:	c7 44 24 04 6b 0c 00 	movl   $0xc6b,0x4(%esp)
 94f:	00 
 ...
 98d:	c7 44 24 04 79 0c 00 	movl   $0xc79,0x4(%esp)
 994:	00 
 ...
 9b9:	c7 44 24 04 86 0c 00 	movl   $0xc86,0x4(%esp)
 9c0:	00 
...
int random(int max){
 ...
 9d7:	a1 b0 0c 00 00       	mov    0xcb0,%eax
 9dc:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 9e2:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 9e7:	a3 b0 0c 00 00       	mov    %eax,0xcb0
    return (int)(rands % max);
 9ec:	a1 b0 0c 00 00       	mov    0xcb0,%eax
...
void sem_acquire(struct Semaphore *s) 
{
 ...
 b24:	e8 a3 fd ff ff       	call   8cc <lock_acquire>
	if( s->count-- < 0) 
 b29:	8b 45 08             	mov    0x8(%ebp),%eax
 b2c:	8b 40 04             	mov    0x4(%eax),%eax
 b2f:	89 c2                	mov    %eax,%edx
 b31:	c1 ea 1f             	shr    $0x1f,%edx
 b34:	8d 48 ff             	lea    -0x1(%eax),%ecx
 b37:	8b 45 08             	mov    0x8(%ebp),%eax
 b3a:	89 48 04             	mov    %ecx,0x4(%eax)
 b3d:	84 d2                	test   %dl,%dl
 b3f:	74 27                	je     b68 <sem_acquire+0x50>
	{
		add_q(&s->q, getpid()); 
 b41:	e8 7e f8 ff ff       	call   3c4 <getpid>
 b46:	8b 55 08             	mov    0x8(%ebp),%edx
 b49:	83 c2 08             	add    $0x8,%edx
 b4c:	89 44 24 04          	mov    %eax,0x4(%esp)
 b50:	89 14 24             	mov    %edx,(%esp)
 b53:	e8 ca fe ff ff       	call   a22 <add_q>
		lock_release(&s->lock); 
 b58:	8b 45 08             	mov    0x8(%ebp),%eax
 b5b:	89 04 24             	mov    %eax,(%esp)
 b5e:	e8 88 fd ff ff       	call   8eb <lock_release>
		tsleep(); 
 b63:	e8 8c f8 ff ff       	call   3f4 <tsleep>
	} 
	lock_release(&s->lock); 
 b68:	8b 45 08             	mov    0x8(%ebp),%eax
 b6b:	89 04 24             	mov    %eax,(%esp)
 b6e:	e8 78 fd ff ff       	call   8eb <lock_release>
}
 b73:	c9                   	leave  
 b74:	c3                   	ret    
...
void sem_init(struct Semaphore *s, int size){
 ...
 bd3:	e8 e6 fc ff ff       	call   8be <lock_init>
	s->count = size; 
 ...
 bea:	e8 11 fe ff ff       	call   a00 <init_q>
}
 bef:	c9                   	leave  
 bf0:	c3                   	ret    
