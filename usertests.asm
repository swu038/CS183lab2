...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
       6:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
       b:	c7 44 24 04 e2 44 00 	movl   $0x44e2,0x4(%esp)
      12:	00 
  ...
  fd = open("echo", 0);
      ...
      22:	00 
      23:	c7 04 24 cc 44 00 00 	movl   $0x44cc,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      38:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
      3d:	c7 44 24 04 ed 44 00 	movl   $0x44ed,0x4(%esp)
      44:	00 
  ...
  fd = open("doesnotexist", 0);
      ...
      64:	00 
      65:	c7 04 24 00 45 00 00 	movl   $0x4500,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      7a:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
      7f:	c7 44 24 04 0d 45 00 	movl   $0x450d,0x4(%esp)
      86:	00 
  ...
  printf(stdout, "open test ok\n");
      94:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
      99:	c7 44 24 04 2b 45 00 	movl   $0x452b,0x4(%esp)
      a0:	00 
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      b1:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
      b6:	c7 44 24 04 39 45 00 	movl   $0x4539,0x4(%esp)
      bd:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
      ...
      cd:	00 
      ce:	c7 04 24 4a 45 00 00 	movl   $0x454a,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      e3:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
      e8:	c7 44 24 04 50 45 00 	movl   $0x4550,0x4(%esp)
      ef:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     104:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     109:	c7 44 24 04 6b 45 00 	movl   $0x456b,0x4(%esp)
     110:	00 
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     125:	00 
     126:	c7 44 24 04 87 45 00 	movl   $0x4587,0x4(%esp)
     12d:	00 
     ...
     13e:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     143:	8b 55 f4             	mov    -0xc(%ebp),%edx
     146:	89 54 24 08          	mov    %edx,0x8(%esp)
     14a:	c7 44 24 04 94 45 00 	movl   $0x4594,0x4(%esp)
     151:	00 
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     166:	00 
     167:	c7 44 24 04 b8 45 00 	movl   $0x45b8,0x4(%esp)
     16e:	00 
     ...
     17f:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     184:	8b 55 f4             	mov    -0xc(%ebp),%edx
     187:	89 54 24 08          	mov    %edx,0x8(%esp)
     18b:	c7 44 24 04 c4 45 00 	movl   $0x45c4,0x4(%esp)
     192:	00 
  ...
  printf(stdout, "writes ok\n");
     1ae:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     1b3:	c7 44 24 04 e8 45 00 	movl   $0x45e8,0x4(%esp)
     1ba:	00 
  ...
  fd = open("small", O_RDONLY);
     ...
     1d5:	00 
     1d6:	c7 04 24 4a 45 00 00 	movl   $0x454a,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     1eb:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     1f0:	c7 44 24 04 f3 45 00 	movl   $0x45f3,0x4(%esp)
     1f7:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     229:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     22e:	c7 44 24 04 0c 46 00 	movl   $0x460c,0x4(%esp)
     235:	00 
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     243:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     248:	c7 44 24 04 27 46 00 	movl   $0x4627,0x4(%esp)
     24f:	00 
  ...
  if(unlink("small") < 0){
     263:	c7 04 24 4a 45 00 00 	movl   $0x454a,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     275:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     27a:	c7 44 24 04 3a 46 00 	movl   $0x463a,0x4(%esp)
     281:	00 
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     28f:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     294:	c7 44 24 04 47 46 00 	movl   $0x4647,0x4(%esp)
     29b:	00 
  ...
  printf(stdout, "small file test ok\n");
     2a9:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     2ae:	c7 44 24 04 5c 46 00 	movl   $0x465c,0x4(%esp)
     2b5:	00 
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     2c6:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     2cb:	c7 44 24 04 70 46 00 	movl   $0x4670,0x4(%esp)
     2d2:	00 
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     2e2:	00 
     2e3:	c7 04 24 80 46 00 00 	movl   $0x4680,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     2f8:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     2fd:	c7 44 24 04 84 46 00 	movl   $0x4684,0x4(%esp)
     304:	00 
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     347:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     34c:	8b 55 ec             	mov    -0x14(%ebp),%edx
     34f:	89 54 24 08          	mov    %edx,0x8(%esp)
     353:	c7 44 24 04 9e 46 00 	movl   $0x469e,0x4(%esp)
     35a:	00 
  ...
  fd = open("big", O_RDONLY);
     ...
     388:	00 
     389:	c7 04 24 80 46 00 00 	movl   $0x4680,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     39e:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     3a3:	c7 44 24 04 bc 46 00 	movl   $0x46bc,0x4(%esp)
     3aa:	00 
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     3f0:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     3f5:	8b 55 f4             	mov    -0xc(%ebp),%edx
     3f8:	89 54 24 08          	mov    %edx,0x8(%esp)
     3fc:	c7 44 24 04 d5 46 00 	movl   $0x46d5,0x4(%esp)
     403:	00 
     ...
     41a:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     41f:	8b 55 ec             	mov    -0x14(%ebp),%edx
     422:	89 54 24 08          	mov    %edx,0x8(%esp)
     426:	c7 44 24 04 f2 46 00 	movl   $0x46f2,0x4(%esp)
     42d:	00 
  ...
  if(unlink("big") < 0){
     488:	c7 04 24 80 46 00 00 	movl   $0x4680,(%esp)
     48f:	e8 d8 37 00 00       	call   3c6c <unlink>
     494:	85 c0                	test   %eax,%eax
     496:	79 1a                	jns    4b2 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
     498:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     49d:	c7 44 24 04 24 47 00 	movl   $0x4724,0x4(%esp)
     4a4:	00 
  ...
  printf(stdout, "big files ok\n");
     4b2:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     4b7:	c7 44 24 04 37 47 00 	movl   $0x4737,0x4(%esp)
     4be:	00 
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4cf:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     4d4:	c7 44 24 04 48 47 00 	movl   $0x4748,0x4(%esp)
     4db:	00 
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56a:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     56f:	c7 44 24 04 70 47 00 	movl   $0x4770,0x4(%esp)
     576:	00 
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     587:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     58c:	c7 44 24 04 96 47 00 	movl   $0x4796,0x4(%esp)
     593:	00 
     594:	89 04 24             	mov    %eax,(%esp)
     597:	e8 19 38 00 00       	call   3db5 <printf>

  if(mkdir("dir0") < 0){
     59c:	c7 04 24 a2 47 00 00 	movl   $0x47a2,(%esp)
     5a3:	e8 dc 36 00 00       	call   3c84 <mkdir>
     5a8:	85 c0                	test   %eax,%eax
     5aa:	79 1a                	jns    5c6 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ac:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     5b1:	c7 44 24 04 a7 47 00 	movl   $0x47a7,0x4(%esp)
     5b8:	00 
  ...
  if(chdir("dir0") < 0){
     5c6:	c7 04 24 a2 47 00 00 	movl   $0x47a2,(%esp)
     5cd:	e8 ba 36 00 00       	call   3c8c <chdir>
     5d2:	85 c0                	test   %eax,%eax
     5d4:	79 1a                	jns    5f0 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d6:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     5db:	c7 44 24 04 b5 47 00 	movl   $0x47b5,0x4(%esp)
     5e2:	00 
  ...
  if(chdir("..") < 0){
     5f0:	c7 04 24 c8 47 00 00 	movl   $0x47c8,(%esp)
     5f7:	e8 90 36 00 00       	call   3c8c <chdir>
     5fc:	85 c0                	test   %eax,%eax
     5fe:	79 1a                	jns    61a <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     600:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     605:	c7 44 24 04 cb 47 00 	movl   $0x47cb,0x4(%esp)
     60c:	00 
  ...
  if(unlink("dir0") < 0){
     61a:	c7 04 24 a2 47 00 00 	movl   $0x47a2,(%esp)
     621:	e8 46 36 00 00       	call   3c6c <unlink>
     626:	85 c0                	test   %eax,%eax
     628:	79 1a                	jns    644 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62a:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     62f:	c7 44 24 04 dc 47 00 	movl   $0x47dc,0x4(%esp)
     636:	00 
  ...
  printf(stdout, "mkdir test\n");
     644:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     649:	c7 44 24 04 96 47 00 	movl   $0x4796,0x4(%esp)
     650:	00 
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     661:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     666:	c7 44 24 04 f0 47 00 	movl   $0x47f0,0x4(%esp)
     66d:	00 
     66e:	89 04 24             	mov    %eax,(%esp)
     671:	e8 3f 37 00 00       	call   3db5 <printf>
  if(exec("echo", echoargv) < 0){
     676:	c7 44 24 04 c4 5b 00 	movl   $0x5bc4,0x4(%esp)
     67d:	00 
     67e:	c7 04 24 cc 44 00 00 	movl   $0x44cc,(%esp)
     685:	e8 ca 35 00 00       	call   3c54 <exec>
     68a:	85 c0                	test   %eax,%eax
     68c:	79 1a                	jns    6a8 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     68e:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
     693:	c7 44 24 04 fb 47 00 	movl   $0x47fb,0x4(%esp)
     69a:	00 
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     6bf:	c7 44 24 04 0d 48 00 	movl   $0x480d,0x4(%esp)
     6c6:	00 
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     74d:	c7 44 24 04 1c 48 00 	movl   $0x481c,0x4(%esp)
     754:	00 
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7c5:	c7 44 24 04 2a 48 00 	movl   $0x482a,0x4(%esp)
     7cc:	00 
    ...
    if(total != 5 * 1033){
     ...
     83b:	c7 44 24 04 38 48 00 	movl   $0x4838,0x4(%esp)
     842:	00 
  ...
  printf(1, "pipe1 ok\n");
     864:	c7 44 24 04 4f 48 00 	movl   $0x484f,0x4(%esp)
     86b:	00 
    ...
    printf(1, "fork() failed\n");
     87a:	c7 44 24 04 59 48 00 	movl   $0x4859,0x4(%esp)
     881:	00 
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89b:	c7 44 24 04 68 48 00 	movl   $0x4868,0x4(%esp)
     8a2:	00 
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     8fd:	00 
     8fe:	c7 44 24 04 72 48 00 	movl   $0x4872,0x4(%esp)
     905:	00 
     ...
     913:	c7 44 24 04 74 48 00 	movl   $0x4874,0x4(%esp)
     91a:	00 
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     95f:	c7 44 24 04 88 48 00 	movl   $0x4888,0x4(%esp)
     966:	00 
  ...
  printf(1, "kill... ");
     980:	c7 44 24 04 9b 48 00 	movl   $0x489b,0x4(%esp)
     987:	00 
  ...
  printf(1, "wait... ");
     9b5:	c7 44 24 04 a4 48 00 	movl   $0x48a4,0x4(%esp)
     9bc:	00 
  ...
  printf(1, "preempt ok\n");
     9d8:	c7 44 24 04 ad 48 00 	movl   $0x48ad,0x4(%esp)
     9df:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a09:	79 16                	jns    a21 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0b:	c7 44 24 04 b9 48 00 	movl   $0x48b9,0x4(%esp)
     a12:	00 
    ...
    if(pid){
     ...
     a31:	c7 44 24 04 c6 48 00 	movl   $0x48c6,0x4(%esp)
     a38:	00 
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a56:	c7 44 24 04 d6 48 00 	movl   $0x48d6,0x4(%esp)
     a5d:	00 
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a72:	c7 44 24 04 e3 48 00 	movl   $0x48e3,0x4(%esp)
     a79:	00 
  ...
  if((pid = fork()) == 0){
    ...
    if(m1 == 0){
     ...
     b02:	c7 44 24 04 ed 48 00 	movl   $0x48ed,0x4(%esp)
     b09:	00 
    ...
    printf(1, "mem ok\n");
     b31:	c7 44 24 04 07 49 00 	movl   $0x4907,0x4(%esp)
     b38:	00 
...
sharedfd(void)
{
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b94:	c7 44 24 04 28 49 00 	movl   $0x4928,0x4(%esp)
     b9b:	00 
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c06:	c7 44 24 04 54 49 00 	movl   $0x4954,0x4(%esp)
     c0d:	00 
  ...
  fd = open("sharedfd", 0);
     ...
     c4b:	00 
     c4c:	c7 04 24 1e 49 00 00 	movl   $0x491e,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c61:	c7 44 24 04 74 49 00 	movl   $0x4974,0x4(%esp)
     c68:	00 
  ...
  unlink("sharedfd");
     cec:	c7 04 24 1e 49 00 00 	movl   $0x491e,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d0a:	c7 44 24 04 9f 49 00 	movl   $0x499f,0x4(%esp)
     d11:	00 
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d2f:	c7 44 24 04 ac 49 00 	movl   $0x49ac,0x4(%esp)
     d36:	00 
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d50:	c7 44 24 04 c1 49 00 	movl   $0x49c1,0x4(%esp)
     d57:	00 
     d58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d5f:	e8 51 30 00 00       	call   3db5 <printf>

  unlink("f1");
     d64:	c7 04 24 d0 49 00 00 	movl   $0x49d0,(%esp)
     d6b:	e8 fc 2e 00 00       	call   3c6c <unlink>
  unlink("f2");
     d70:	c7 04 24 d3 49 00 00 	movl   $0x49d3,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d8a:	c7 44 24 04 b9 48 00 	movl   $0x48b9,0x4(%esp)
     d91:	00 
  ...
  fname = pid ? "f1" : "f2";
     ...
     da9:	b8 d0 49 00 00       	mov    $0x49d0,%eax
     dae:	eb 05                	jmp    db5 <twofiles+0x6b>
     db0:	b8 d3 49 00 00       	mov    $0x49d3,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     dd4:	c7 44 24 04 d6 49 00 	movl   $0x49d6,0x4(%esp)
     ddb:	00 
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e4e:	c7 44 24 04 e5 49 00 	movl   $0x49e5,0x4(%esp)
     e55:	00 
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     e9e:	b8 d0 49 00 00       	mov    $0x49d0,%eax
     ea3:	eb 05                	jmp    eaa <twofiles+0x160>
     ea5:	b8 d3 49 00 00       	mov    $0x49d3,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     ef0:	74 19                	je     f0b <twofiles+0x1c1>
          printf(1, "wrong char\n");
     ef2:	c7 44 24 04 f6 49 00 	movl   $0x49f6,0x4(%esp)
     ef9:	00 
  ...
  for(i = 0; i < 2; i++){
    ...
    if(total != 12*500){
     ...
     f5c:	c7 44 24 04 02 4a 00 	movl   $0x4a02,0x4(%esp)
     f63:	00 
  ...
  unlink("f1");
     f83:	c7 04 24 d0 49 00 00 	movl   $0x49d0,(%esp)
     f8a:	e8 dd 2c 00 00       	call   3c6c <unlink>
  unlink("f2");
     f8f:	c7 04 24 d3 49 00 00 	movl   $0x49d3,(%esp)
     f96:	e8 d1 2c 00 00       	call   3c6c <unlink>

  printf(1, "twofiles ok\n");
     f9b:	c7 44 24 04 13 4a 00 	movl   $0x4a13,0x4(%esp)
     fa2:	00 
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fb7:	c7 44 24 04 20 4a 00 	movl   $0x4a20,0x4(%esp)
     fbe:	00 
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fd9:	c7 44 24 04 b9 48 00 	movl   $0x48b9,0x4(%esp)
     fe0:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    103a:	79 19                	jns    1055 <createdelete+0xa4>
      printf(1, "create failed\n");
    103c:	c7 44 24 04 d6 49 00 	movl   $0x49d6,0x4(%esp)
    1043:	00 
    ...
    1092:	c7 44 24 04 33 4a 00 	movl   $0x4a33,0x4(%esp)
    1099:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    1111:	c7 44 24 04 44 4a 00 	movl   $0x4a44,0x4(%esp)
    1118:	00 
    ...
    1143:	c7 44 24 04 68 4a 00 	movl   $0x4a68,0x4(%esp)
    114a:	00 
    ...
    11a9:	c7 44 24 04 44 4a 00 	movl   $0x4a44,0x4(%esp)
    11b0:	00 
    ...
    11db:	c7 44 24 04 68 4a 00 	movl   $0x4a68,0x4(%esp)
    11e2:	00 
  ...
  printf(1, "createdelete ok\n");
    124d:	c7 44 24 04 88 4a 00 	movl   $0x4a88,0x4(%esp)
    1254:	00 
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1269:	c7 44 24 04 99 4a 00 	movl   $0x4a99,0x4(%esp)
    1270:	00 
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1284:	00 
    1285:	c7 04 24 aa 4a 00 00 	movl   $0x4aaa,(%esp)
  ...
  if(fd < 0){
    ...
    129a:	c7 44 24 04 b5 4a 00 	movl   $0x4ab5,0x4(%esp)
    12a1:	00 
  ...
  write(fd, "hello", 5);
    ...
    12ba:	00 
    12bb:	c7 44 24 04 cf 4a 00 	movl   $0x4acf,0x4(%esp)
    12c2:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e0:	00 
    12e1:	c7 04 24 aa 4a 00 00 	movl   $0x4aaa,(%esp)
  ...
  if(fd < 0){
    ...
    12f6:	c7 44 24 04 d5 4a 00 	movl   $0x4ad5,0x4(%esp)
    12fd:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1395:	c7 44 24 04 0b 4b 00 	movl   $0x4b0b,0x4(%esp)
    139c:	00 
  ...
  if(buf[0] != 'h'){
    ...
    13b9:	c7 44 24 04 22 4b 00 	movl   $0x4b22,0x4(%esp)
    13c0:	00 
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13f2:	c7 44 24 04 39 4b 00 	movl   $0x4b39,0x4(%esp)
    13f9:	00 
  ...
  unlink("unlinkread");
    1416:	c7 04 24 aa 4a 00 00 	movl   $0x4aaa,(%esp)
    141d:	e8 4a 28 00 00       	call   3c6c <unlink>
  printf(1, "unlinkread ok\n");
    1422:	c7 44 24 04 52 4b 00 	movl   $0x4b52,0x4(%esp)
    1429:	00 
...
linktest(void)
{
  ...
  if(fd < 0){
    ...
    1487:	c7 44 24 04 73 4b 00 	movl   $0x4b73,0x4(%esp)
    148e:	00 
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14a7:	00 
    14a8:	c7 44 24 04 cf 4a 00 	movl   $0x4acf,0x4(%esp)
    14af:	00 
    ...
    14c0:	c7 44 24 04 86 4b 00 	movl   $0x4b86,0x4(%esp)
    14c7:	00 
  ...
  if(link("lf1", "lf2") < 0){
    14e4:	c7 44 24 04 6f 4b 00 	movl   $0x4b6f,0x4(%esp)
    14eb:	00 
    14ec:	c7 04 24 6b 4b 00 00 	movl   $0x4b6b,(%esp)
    14f3:	e8 84 27 00 00       	call   3c7c <link>
    14f8:	85 c0                	test   %eax,%eax
    14fa:	79 19                	jns    1515 <linktest+0xdd>
    printf(1, "link lf1 lf2 failed\n");
    14fc:	c7 44 24 04 98 4b 00 	movl   $0x4b98,0x4(%esp)
    1503:	00 
  ...
  fd = open("lf2", 0);
    ...
    1559:	00 
    155a:	c7 04 24 6f 4b 00 00 	movl   $0x4b6f,(%esp)
  ...
  if(fd < 0){
    ...
    156f:	c7 44 24 04 d5 4b 00 	movl   $0x4bd5,0x4(%esp)
    1576:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    15a8:	c7 44 24 04 e6 4b 00 	movl   $0x4be6,0x4(%esp)
    15af:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    15cc:	c7 44 24 04 6f 4b 00 	movl   $0x4b6f,0x4(%esp)
    15d3:	00 
    15d4:	c7 04 24 6f 4b 00 00 	movl   $0x4b6f,(%esp)
    15db:	e8 9c 26 00 00       	call   3c7c <link>
    15e0:	85 c0                	test   %eax,%eax
    15e2:	78 19                	js     15fd <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15e4:	c7 44 24 04 f7 4b 00 	movl   $0x4bf7,0x4(%esp)
    15eb:	00 
  ...
  unlink("lf2");
    15fd:	c7 04 24 6f 4b 00 00 	movl   $0x4b6f,(%esp)
    1604:	e8 63 26 00 00       	call   3c6c <unlink>
  if(link("lf2", "lf1") >= 0){
    1609:	c7 44 24 04 6b 4b 00 	movl   $0x4b6b,0x4(%esp)
    1610:	00 
    1611:	c7 04 24 6f 4b 00 00 	movl   $0x4b6f,(%esp)
    1618:	e8 5f 26 00 00       	call   3c7c <link>
    161d:	85 c0                	test   %eax,%eax
    161f:	78 19                	js     163a <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    1621:	c7 44 24 04 18 4c 00 	movl   $0x4c18,0x4(%esp)
    1628:	00 
  ...
  if(link(".", "lf1") >= 0){
    163a:	c7 44 24 04 6b 4b 00 	movl   $0x4b6b,0x4(%esp)
    1641:	00 
    1642:	c7 04 24 3b 4c 00 00 	movl   $0x4c3b,(%esp)
    1649:	e8 2e 26 00 00       	call   3c7c <link>
    164e:	85 c0                	test   %eax,%eax
    1650:	78 19                	js     166b <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    1652:	c7 44 24 04 3d 4c 00 	movl   $0x4c3d,0x4(%esp)
    1659:	00 
  ...
  printf(1, "linktest ok\n");
    166b:	c7 44 24 04 59 4c 00 	movl   $0x4c59,0x4(%esp)
    1672:	00 
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1687:	c7 44 24 04 66 4c 00 	movl   $0x4c66,0x4(%esp)
    168e:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    16fa:	c7 04 24 76 4c 00 00 	movl   $0x4c76,(%esp)
  ...
  for(i = 0; i < 40; i++){
    ...
    173d:	c7 04 24 76 4c 00 00 	movl   $0x4c76,(%esp)
    ...
    176e:	c7 44 24 04 79 4c 00 	movl   $0x4c79,0x4(%esp)
    1775:	00 
  ...
  fd = open(".", 0);
    ...
    17d2:	00 
    17d3:	c7 04 24 3b 4c 00 00 	movl   $0x4c3b,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1834:	c7 44 24 04 95 4c 00 	movl   $0x4c95,0x4(%esp)
    183b:	00 
    ...
    1863:	c7 44 24 04 ae 4c 00 	movl   $0x4cae,0x4(%esp)
    186a:	00 
  ...
  if(n != 40){
    ...
    18be:	c7 44 24 04 cc 4c 00 	movl   $0x4ccc,0x4(%esp)
    18c5:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    18f8:	79 19                	jns    1913 <concreate+0x292>
      printf(1, "fork failed\n");
    18fa:	c7 44 24 04 b9 48 00 	movl   $0x48b9,0x4(%esp)
    1901:	00 
  ...
  printf(1, "concreate ok\n");
    1a1a:	c7 44 24 04 fd 4c 00 	movl   $0x4cfd,0x4(%esp)
    1a21:	00 
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a36:	c7 44 24 04 0b 4d 00 	movl   $0x4d0b,0x4(%esp)
    1a3d:	00 
    1a3e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a45:	e8 6b 23 00 00       	call   3db5 <printf>

  unlink("x");
    1a4a:	c7 04 24 72 48 00 00 	movl   $0x4872,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a64:	c7 44 24 04 b9 48 00 	movl   $0x48b9,0x4(%esp)
    1a6b:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    1ad2:	00 
    1ad3:	c7 04 24 72 48 00 00 	movl   $0x4872,(%esp)
    ...
    1b04:	75 16                	jne    1b1c <linkunlink+0xec>
      link("cat", "x");
    1b06:	c7 44 24 04 72 48 00 	movl   $0x4872,0x4(%esp)
    1b0d:	00 
    1b0e:	c7 04 24 1c 4d 00 00 	movl   $0x4d1c,(%esp)
    1b15:	e8 62 21 00 00       	call   3c7c <link>
    1b1a:	eb 0c                	jmp    1b28 <linkunlink+0xf8>
    } else {
      unlink("x");
    1b1c:	c7 04 24 72 48 00 00 	movl   $0x4872,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b41:	c7 44 24 04 20 4d 00 	movl   $0x4d20,0x4(%esp)
    1b48:	00 
...
bigdir(void)
{
  ...
  if(fd < 0){
    ...
    1b9f:	c7 44 24 04 3f 4d 00 	movl   $0x4d3f,0x4(%esp)
    1ba6:	00 
  ...
  unlink("bd");
    1c3d:	c7 04 24 3c 4d 00 00 	movl   $0x4d3c,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c95:	c7 44 24 04 69 4d 00 	movl   $0x4d69,0x4(%esp)
    1c9c:	00 
  ...
  printf(1, "bigdir ok\n");
    1cbb:	c7 44 24 04 7e 4d 00 	movl   $0x4d7e,0x4(%esp)
    1cc2:	00 
...
subdir(void)
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d27:	00 
    1d28:	c7 04 24 b4 4d 00 00 	movl   $0x4db4,(%esp)
  ...
  if(fd < 0){
    ...
    1d3d:	c7 44 24 04 ba 4d 00 	movl   $0x4dba,0x4(%esp)
    1d44:	00 
  ...
  write(fd, "ff", 2);
    ...
    1d5d:	00 
    1d5e:	c7 44 24 04 96 4d 00 	movl   $0x4d96,0x4(%esp)
    1d65:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dd5:	00 
    1dd6:	c7 04 24 18 4e 00 00 	movl   $0x4e18,(%esp)
  ...
  if(fd < 0){
    ...
    1deb:	c7 44 24 04 21 4e 00 	movl   $0x4e21,0x4(%esp)
    1df2:	00 
  ...
  write(fd, "FF", 2);
    ...
    1e0b:	00 
    1e0c:	c7 44 24 04 39 4e 00 	movl   $0x4e39,0x4(%esp)
    1e13:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e31:	00 
    1e32:	c7 04 24 3c 4e 00 00 	movl   $0x4e3c,(%esp)
  ...
  if(fd < 0){
    ...
    1e47:	c7 44 24 04 48 4e 00 	movl   $0x4e48,0x4(%esp)
    1e4e:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e8f:	c7 44 24 04 61 4e 00 	movl   $0x4e61,0x4(%esp)
    1e96:	00 
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1eb3:	c7 44 24 04 7c 4e 00 	movl   $0x4e7c,0x4(%esp)
    1eba:	00 
    1ebb:	c7 04 24 18 4e 00 00 	movl   $0x4e18,(%esp)
    1ec2:	e8 b5 1d 00 00       	call   3c7c <link>
    1ec7:	85 c0                	test   %eax,%eax
    1ec9:	74 19                	je     1ee4 <subdir+0x213>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    1ecb:	c7 44 24 04 88 4e 00 	movl   $0x4e88,0x4(%esp)
    1ed2:	00 
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1fe9:	00 
    1fea:	c7 04 24 7c 4e 00 00 	movl   $0x4e7c,(%esp)
  ...
  if(fd < 0){
    ...
    1fff:	c7 44 24 04 46 4f 00 	movl   $0x4f46,0x4(%esp)
    2006:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2038:	c7 44 24 04 5e 4f 00 	movl   $0x4f5e,0x4(%esp)
    203f:	00 
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2182:	c7 44 24 04 35 50 00 	movl   $0x5035,0x4(%esp)
    2189:	00 
    218a:	c7 04 24 a1 4f 00 00 	movl   $0x4fa1,(%esp)
    2191:	e8 e6 1a 00 00       	call   3c7c <link>
    2196:	85 c0                	test   %eax,%eax
    2198:	75 19                	jne    21b3 <subdir+0x4e2>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    219a:	c7 44 24 04 40 50 00 	movl   $0x5040,0x4(%esp)
    21a1:	00 
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    21b3:	c7 44 24 04 35 50 00 	movl   $0x5035,0x4(%esp)
    21ba:	00 
    21bb:	c7 04 24 c6 4f 00 00 	movl   $0x4fc6,(%esp)
    21c2:	e8 b5 1a 00 00       	call   3c7c <link>
    21c7:	85 c0                	test   %eax,%eax
    21c9:	75 19                	jne    21e4 <subdir+0x513>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    21cb:	c7 44 24 04 64 50 00 	movl   $0x5064,0x4(%esp)
    21d2:	00 
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    21e4:	c7 44 24 04 7c 4e 00 	movl   $0x4e7c,0x4(%esp)
    21eb:	00 
    21ec:	c7 04 24 b4 4d 00 00 	movl   $0x4db4,(%esp)
    21f3:	e8 84 1a 00 00       	call   3c7c <link>
    21f8:	85 c0                	test   %eax,%eax
    21fa:	75 19                	jne    2215 <subdir+0x544>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    21fc:	c7 44 24 04 88 50 00 	movl   $0x5088,0x4(%esp)
    2203:	00 
  ...
  printf(1, "subdir ok\n");
    2401:	c7 44 24 04 cd 51 00 	movl   $0x51cd,0x4(%esp)
    2408:	00 
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    241d:	c7 44 24 04 d8 51 00 	movl   $0x51d8,0x4(%esp)
    2424:	00 
    2425:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    242c:	e8 84 19 00 00       	call   3db5 <printf>

  unlink("bigwrite");
    2431:	c7 04 24 e7 51 00 00 	movl   $0x51e7,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2450:	00 
    2451:	c7 04 24 e7 51 00 00 	movl   $0x51e7,(%esp)
    ...
    2466:	c7 44 24 04 f0 51 00 	movl   $0x51f0,0x4(%esp)
    246d:	00 
    ...
    24bb:	c7 44 24 04 08 52 00 	movl   $0x5208,0x4(%esp)
    24c2:	00 
    ...
    unlink("bigwrite");
    24e9:	c7 04 24 e7 51 00 00 	movl   $0x51e7,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    2509:	c7 44 24 04 1a 52 00 	movl   $0x521a,0x4(%esp)
    2510:	00 
...
bigfile(void)
{
  ...
  if(fd < 0){
    ...
    2562:	c7 44 24 04 3d 52 00 	movl   $0x523d,0x4(%esp)
    2569:	00 
  ...
  for(i = 0; i < 20; i++){
    ...
    25c1:	c7 44 24 04 53 52 00 	movl   $0x5253,0x4(%esp)
    25c8:	00 
  ...
  fd = open("bigfile", 0);
    ...
    25f6:	00 
    25f7:	c7 04 24 35 52 00 00 	movl   $0x5235,(%esp)
  ...
  if(fd < 0){
    ...
    260c:	c7 44 24 04 69 52 00 	movl   $0x5269,0x4(%esp)
    2613:	00 
  ...
  for(i = 0; ; i++){
    ...
    2657:	c7 44 24 04 7e 52 00 	movl   $0x527e,0x4(%esp)
    265e:	00 
    ...
    2683:	c7 44 24 04 93 52 00 	movl   $0x5293,0x4(%esp)
    268a:	00 
    ...
    26d2:	c7 44 24 04 a7 52 00 	movl   $0x52a7,0x4(%esp)
    26d9:	00 
  ...
  if(total != 20*600){
    ...
    270f:	c7 44 24 04 c0 52 00 	movl   $0x52c0,0x4(%esp)
    2716:	00 
  ...
  unlink("bigfile");
    2728:	c7 04 24 35 52 00 00 	movl   $0x5235,(%esp)
    272f:	e8 38 15 00 00       	call   3c6c <unlink>

  printf(1, "bigfile test ok\n");
    2734:	c7 44 24 04 da 52 00 	movl   $0x52da,0x4(%esp)
    273b:	00 
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27bd:	00 
    27be:	c7 04 24 78 53 00 00 	movl   $0x5378,(%esp)
  ...
  if(fd < 0){
    ...
    27d3:	c7 44 24 04 a8 53 00 	movl   $0x53a8,0x4(%esp)
    27da:	00 
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27fe:	00 
    27ff:	c7 04 24 e8 53 00 00 	movl   $0x53e8,(%esp)
  ...
  if(fd < 0){
    ...
    2814:	c7 44 24 04 18 54 00 	movl   $0x5418,0x4(%esp)
    281b:	00 
  ...
  printf(1, "fourteen ok\n");
    288a:	c7 44 24 04 f1 54 00 	movl   $0x54f1,0x4(%esp)
    2891:	00 
...
rmdot(void)
{
  ...
  printf(1, "rmdot ok\n");
    2a02:	c7 44 24 04 b7 55 00 	movl   $0x55b7,0x4(%esp)
    2a09:	00 
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a1e:	c7 44 24 04 c1 55 00 	movl   $0x55c1,0x4(%esp)
    2a25:	00 
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2a39:	00 
    2a3a:	c7 04 24 ce 55 00 00 	movl   $0x55ce,(%esp)
  ...
  if(fd < 0){
    ...
    2a4f:	c7 44 24 04 d6 55 00 	movl   $0x55d6,0x4(%esp)
    2a56:	00 
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aa3:	00 
    2aa4:	c7 04 24 07 56 00 00 	movl   $0x5607,(%esp)
  ...
  if(fd >= 0){
    ...
    2ab9:	c7 44 24 04 12 56 00 	movl   $0x5612,0x4(%esp)
    2ac0:	00 
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ad9:	00 
    2ada:	c7 04 24 07 56 00 00 	movl   $0x5607,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(1, "create dirfile/xx succeeded!\n");
    2aef:	c7 44 24 04 12 56 00 	movl   $0x5612,0x4(%esp)
    2af6:	00 
  ...
  if(link("README", "dirfile/xx") == 0){
    2b5a:	c7 44 24 04 07 56 00 	movl   $0x5607,0x4(%esp)
    2b61:	00 
    2b62:	c7 04 24 6b 56 00 00 	movl   $0x566b,(%esp)
    2b69:	e8 0e 11 00 00       	call   3c7c <link>
    2b6e:	85 c0                	test   %eax,%eax
    2b70:	75 19                	jne    2b8b <dirfile+0x173>
    printf(1, "link to dirfile/xx succeeded!\n");
    2b72:	c7 44 24 04 74 56 00 	movl   $0x5674,0x4(%esp)
    2b79:	00 
  ...
  fd = open(".", O_RDWR);
    ...
    2bbb:	00 
    2bbc:	c7 04 24 3b 4c 00 00 	movl   $0x4c3b,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd1:	c7 44 24 04 ac 56 00 	movl   $0x56ac,0x4(%esp)
    2bd8:	00 
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c20:	c7 44 24 04 cb 56 00 	movl   $0x56cb,0x4(%esp)
    2c27:	00 
  ...
  printf(1, "dir vs file OK\n");
    2c44:	c7 44 24 04 df 56 00 	movl   $0x56df,0x4(%esp)
    2c4b:	00 
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c60:	c7 44 24 04 ef 56 00 	movl   $0x56ef,0x4(%esp)
    2c67:	00 
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    mkdir("");
    2cd2:	c7 04 24 2e 57 00 00 	movl   $0x572e,(%esp)
    2cd9:	e8 a6 0f 00 00       	call   3c84 <mkdir>
    link("README", "");
    2cde:	c7 44 24 04 2e 57 00 	movl   $0x572e,0x4(%esp)
    2ce5:	00 
    2ce6:	c7 04 24 6b 56 00 00 	movl   $0x566b,(%esp)
    2ced:	e8 8a 0f 00 00       	call   3c7c <link>
    fd = open("", O_CREATE);
    2cf2:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cf9:	00 
    2cfa:	c7 04 24 2e 57 00 00 	movl   $0x572e,(%esp)
    ...
    2d21:	00 
    2d22:	c7 04 24 2f 57 00 00 	movl   $0x572f,(%esp)
    ...
    unlink("xx");
    2d42:	c7 04 24 2f 57 00 00 	movl   $0x572f,(%esp)
  ...
  chdir("/");
    2d5c:	c7 04 24 52 55 00 00 	movl   $0x5552,(%esp)
    2d63:	e8 24 0f 00 00       	call   3c8c <chdir>
  printf(1, "empty file name OK\n");
    2d68:	c7 44 24 04 32 57 00 	movl   $0x5732,0x4(%esp)
    2d6f:	00 
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d84:	c7 44 24 04 46 57 00 	movl   $0x5746,0x4(%esp)
    2d8b:	00 
    ...
    2db5:	e8 62 0e 00 00       	call   3c1c <exit>
{
  ...
  if(n == 1000){
    ...
    2dd3:	c7 44 24 04 54 57 00 	movl   $0x5754,0x4(%esp)
    2dda:	00 
  ...
  for(; n > 0; n--){
    ...
    2df5:	c7 44 24 04 76 57 00 	movl   $0x5776,0x4(%esp)
    2dfc:	00 
  ...
  if(wait() != -1){
    ...
    2e22:	c7 44 24 04 8a 57 00 	movl   $0x578a,0x4(%esp)
    2e29:	00 
  ...
  printf(1, "fork test OK\n");
    2e3b:	c7 44 24 04 9d 57 00 	movl   $0x579d,0x4(%esp)
    2e42:	00 
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e5b:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    2e60:	c7 44 24 04 ab 57 00 	movl   $0x57ab,0x4(%esp)
    2e67:	00 
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eae:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    ...
    2ec8:	c7 44 24 04 b6 57 00 	movl   $0x57b6,0x4(%esp)
    2ecf:	00 
  ...
  if(pid < 0){
    ...
    2f07:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    2f0c:	c7 44 24 04 d1 57 00 	movl   $0x57d1,0x4(%esp)
    2f13:	00 
  ...
  if(c != a + 1){
    ...
    2f4a:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    2f4f:	c7 44 24 04 e8 57 00 	movl   $0x57e8,0x4(%esp)
    2f56:	00 
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2faa:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    2faf:	c7 44 24 04 04 58 00 	movl   $0x5804,0x4(%esp)
    2fb6:	00 
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ff5:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    2ffa:	c7 44 24 04 42 58 00 	movl   $0x5842,0x4(%esp)
    3001:	00 
  ...
  if(c != a - 4096){
    ...
    302b:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    ...
    303e:	c7 44 24 04 60 58 00 	movl   $0x5860,0x4(%esp)
    3045:	00 
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3092:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    ...
    30a5:	c7 44 24 04 98 58 00 	movl   $0x5898,0x4(%esp)
    30ac:	00 
  ...
  if(*lastaddr == 99){
    ...
    30c4:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    30c9:	c7 44 24 04 c0 58 00 	movl   $0x58c0,0x4(%esp)
    30d0:	00 
  ...
  if(c != a){
    ...
    3115:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    ...
    3128:	c7 44 24 04 f0 58 00 	movl   $0x58f0,0x4(%esp)
    312f:	00 
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    315c:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    3161:	c7 44 24 04 b9 48 00 	movl   $0x48b9,0x4(%esp)
    3168:	00 
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31dd:	c7 44 24 04 0d 48 00 	movl   $0x480d,0x4(%esp)
    31e4:	00 
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    323f:	00 
    3240:	c7 44 24 04 72 48 00 	movl   $0x4872,0x4(%esp)
    3247:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e1:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    32e6:	c7 44 24 04 2a 59 00 	movl   $0x592a,0x4(%esp)
    32ed:	00 
  ...
  printf(stdout, "sbrk test OK\n");
    3329:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    332e:	c7 44 24 04 45 59 00 	movl   $0x5945,0x4(%esp)
    3335:	00 
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    336f:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    3374:	c7 44 24 04 53 59 00 	movl   $0x5953,0x4(%esp)
    337b:	00 
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33e1:	c7 04 24 62 59 00 00 	movl   $0x5962,(%esp)
    33e8:	e8 8f 08 00 00       	call   3c7c <link>
    33ed:	83 f8 ff             	cmp    $0xffffffff,%eax
    33f0:	74 1a                	je     340c <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33f2:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    33f7:	c7 44 24 04 6d 59 00 	movl   $0x596d,0x4(%esp)
    33fe:	00 
  ...
  printf(stdout, "validate ok\n");
    341f:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    3424:	c7 44 24 04 86 59 00 	movl   $0x5986,0x4(%esp)
    342b:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    343c:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    3441:	c7 44 24 04 93 59 00 	movl   $0x5993,0x4(%esp)
    3448:	00 
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3468:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    346d:	c7 44 24 04 9d 59 00 	movl   $0x599d,0x4(%esp)
    3474:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3490:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    3495:	c7 44 24 04 ae 59 00 	movl   $0x59ae,0x4(%esp)
    349c:	00 
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34ad:	c7 04 24 bb 59 00 00 	movl   $0x59bb,(%esp)
  ...
  if(pid == 0){
    ...
    34d7:	c7 04 85 00 5c 00 00 	movl   $0x59c8,0x5c00(,%eax,4)
    34de:	c8 59 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    34f6:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    34fb:	c7 44 24 04 a5 5a 00 	movl   $0x5aa5,0x4(%esp)
    3502:	00 
    ...
    3512:	00 
    3513:	c7 04 24 cc 44 00 00 	movl   $0x44cc,(%esp)
    351a:	e8 35 07 00 00       	call   3c54 <exec>
    printf(stdout, "bigarg test ok\n");
    351f:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    3524:	c7 44 24 04 b2 5a 00 	movl   $0x5ab2,0x4(%esp)
    352b:	00 
    ...
    353b:	00 
    353c:	c7 04 24 bb 59 00 00 	movl   $0x59bb,(%esp)
    ...
    3561:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    3566:	c7 44 24 04 c2 5a 00 	movl   $0x5ac2,0x4(%esp)
    356d:	00 
  ...
  fd = open("bigarg-ok", 0);
    ...
    3587:	00 
    3588:	c7 04 24 bb 59 00 00 	movl   $0x59bb,(%esp)
  ...
  if(fd < 0){
    ...
    359d:	a1 d8 5b 00 00       	mov    0x5bd8,%eax
    35a2:	c7 44 24 04 db 5a 00 	movl   $0x5adb,0x4(%esp)
    35a9:	00 
  ...
  unlink("bigarg-ok");
    35c2:	c7 04 24 bb 59 00 00 	movl   $0x59bb,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35de:	c7 44 24 04 f0 5a 00 	movl   $0x5af0,0x4(%esp)
    35e5:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36ce:	c7 44 24 04 fd 5a 00 	movl   $0x5afd,0x4(%esp)
    36d5:	00 
    ...
    3705:	c7 44 24 04 09 5b 00 	movl   $0x5b09,0x4(%esp)
    370c:	00 
    ...
    375d:	c7 44 24 04 19 5b 00 	movl   $0x5b19,0x4(%esp)
    3764:	00 
  ...
  printf(1, "fsfull test finished\n");
    3879:	c7 44 24 04 29 5b 00 	movl   $0x5b29,0x4(%esp)
    3880:	00 
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3896:	a1 dc 5b 00 00       	mov    0x5bdc,%eax
    389b:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    38a1:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    38a6:	a3 dc 5b 00 00       	mov    %eax,0x5bdc
  return randstate;
    38ab:	a1 dc 5b 00 00       	mov    0x5bdc,%eax
}
    38b0:	5d                   	pop    %ebp
    38b1:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    38bb:	c7 44 24 04 3f 5b 00 	movl   $0x5b3f,0x4(%esp)
    38c2:	00 
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3907:	00 
    3908:	c7 04 24 53 5b 00 00 	movl   $0x5b53,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    3d4e:	0f b6 80 e0 5b 00 00 	movzbl 0x5be0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    3eac:	75 27                	jne    3ed5 <printf+0x120>
          s = "(null)";
    3eae:	c7 45 e4 8e 5b 00 00 	movl   $0x5b8e,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3f7b:	a1 88 5c 00 00       	mov    0x5c88,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    403c:	a3 88 5c 00 00       	mov    %eax,0x5c88
}
    4041:	c9                   	leave  
    4042:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    4094:	a1 88 5c 00 00       	mov    0x5c88,%eax
}
    4099:	c9                   	leave  
    409a:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    40b0:	a1 88 5c 00 00       	mov    0x5c88,%eax
    40b5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40b8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40bc:	75 23                	jne    40e1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40be:	c7 45 f0 80 5c 00 00 	movl   $0x5c80,-0x10(%ebp)
    40c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40c8:	a3 88 5c 00 00       	mov    %eax,0x5c88
    40cd:	a1 88 5c 00 00       	mov    0x5c88,%eax
    40d2:	a3 80 5c 00 00       	mov    %eax,0x5c80
    base.s.size = 0;
    40d7:	c7 05 84 5c 00 00 00 	movl   $0x0,0x5c84
    40de:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    4134:	a3 88 5c 00 00       	mov    %eax,0x5c88
      return (void*)(p + 1);
    ...
    if(p == freep)
    4141:	a1 88 5c 00 00       	mov    0x5c88,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    4220:	c7 44 24 04 95 5b 00 	movl   $0x5b95,0x4(%esp)
    4227:	00 
    ...
    4265:	c7 44 24 04 a3 5b 00 	movl   $0x5ba3,0x4(%esp)
    426c:	00 
    ...
    4291:	c7 44 24 04 b0 5b 00 	movl   $0x5bb0,0x4(%esp)
    4298:	00 
...
int random(int max){
    ...
    42af:	a1 f4 5b 00 00       	mov    0x5bf4,%eax
    42b4:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    42ba:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    42bf:	a3 f4 5b 00 00       	mov    %eax,0x5bf4
    return (int)(rands % max);
    42c4:	a1 f4 5b 00 00       	mov    0x5bf4,%eax
...
void sem_acquire(struct Semaphore *s) 
{
    ...
    43fc:	e8 a3 fd ff ff       	call   41a4 <lock_acquire>
	if( s->count-- < 0) 
    4401:	8b 45 08             	mov    0x8(%ebp),%eax
    4404:	8b 40 04             	mov    0x4(%eax),%eax
    4407:	89 c2                	mov    %eax,%edx
    4409:	c1 ea 1f             	shr    $0x1f,%edx
    440c:	8d 48 ff             	lea    -0x1(%eax),%ecx
    440f:	8b 45 08             	mov    0x8(%ebp),%eax
    4412:	89 48 04             	mov    %ecx,0x4(%eax)
    4415:	84 d2                	test   %dl,%dl
    4417:	74 27                	je     4440 <sem_acquire+0x50>
	{
		add_q(&s->q, getpid()); 
    4419:	e8 7e f8 ff ff       	call   3c9c <getpid>
    441e:	8b 55 08             	mov    0x8(%ebp),%edx
    4421:	83 c2 08             	add    $0x8,%edx
    4424:	89 44 24 04          	mov    %eax,0x4(%esp)
    4428:	89 14 24             	mov    %edx,(%esp)
    442b:	e8 ca fe ff ff       	call   42fa <add_q>
		lock_release(&s->lock); 
    4430:	8b 45 08             	mov    0x8(%ebp),%eax
    4433:	89 04 24             	mov    %eax,(%esp)
    4436:	e8 88 fd ff ff       	call   41c3 <lock_release>
		tsleep(); 
    443b:	e8 8c f8 ff ff       	call   3ccc <tsleep>
	} 
	lock_release(&s->lock); 
    4440:	8b 45 08             	mov    0x8(%ebp),%eax
    4443:	89 04 24             	mov    %eax,(%esp)
    4446:	e8 78 fd ff ff       	call   41c3 <lock_release>
}
    444b:	c9                   	leave  
    444c:	c3                   	ret    
...
{ 
    444d:	55                   	push   %ebp
    444e:	89 e5                	mov    %esp,%ebp
    4450:	83 ec 28             	sub    $0x28,%esp
	lock_acquire(&s->lock); 
    4453:	8b 45 08             	mov    0x8(%ebp),%eax
    4456:	89 04 24             	mov    %eax,(%esp)
    4459:	e8 46 fd ff ff       	call   41a4 <lock_acquire>
	if( s->count++ <= 0) 
    445e:	8b 45 08             	mov    0x8(%ebp),%eax
    4461:	8b 40 04             	mov    0x4(%eax),%eax
    4464:	85 c0                	test   %eax,%eax
    4466:	0f 9e c2             	setle  %dl
    4469:	8d 48 01             	lea    0x1(%eax),%ecx
    446c:	8b 45 08             	mov    0x8(%ebp),%eax
    446f:	89 48 04             	mov    %ecx,0x4(%eax)
    4472:	84 d2                	test   %dl,%dl
    4474:	74 1c                	je     4492 <sem_signal+0x45>
	{
		int tid = pop_q(&s->q); 
    4476:	8b 45 08             	mov    0x8(%ebp),%eax
    4479:	83 c0 08             	add    $0x8,%eax
    447c:	89 04 24             	mov    %eax,(%esp)
    447f:	e8 f0 fe ff ff       	call   4374 <pop_q>
    4484:	89 45 f4             	mov    %eax,-0xc(%ebp)
		twakeup(tid); 
    4487:	8b 45 f4             	mov    -0xc(%ebp),%eax
    448a:	89 04 24             	mov    %eax,(%esp)
    448d:	e8 42 f8 ff ff       	call   3cd4 <twakeup>
	}
	lock_release(&s->lock); 
    4492:	8b 45 08             	mov    0x8(%ebp),%eax
    4495:	89 04 24             	mov    %eax,(%esp)
    4498:	e8 26 fd ff ff       	call   41c3 <lock_release>
} 
    449d:	c9                   	leave  
    449e:	c3                   	ret    
...
void sem_init(struct Semaphore *s, int size){
    449f:	55                   	push   %ebp
    44a0:	89 e5                	mov    %esp,%ebp
    44a2:	83 ec 18             	sub    $0x18,%esp
	lock_init(&s->lock);
    44a5:	8b 45 08             	mov    0x8(%ebp),%eax
    44a8:	89 04 24             	mov    %eax,(%esp)
    44ab:	e8 e6 fc ff ff       	call   4196 <lock_init>
	s->count = size; 
    44b0:	8b 45 08             	mov    0x8(%ebp),%eax
    44b3:	8b 55 0c             	mov    0xc(%ebp),%edx
    44b6:	89 50 04             	mov    %edx,0x4(%eax)
	init_q(&s->q);
    44b9:	8b 45 08             	mov    0x8(%ebp),%eax
    44bc:	83 c0 08             	add    $0x8,%eax
    44bf:	89 04 24             	mov    %eax,(%esp)
    44c2:	e8 11 fe ff ff       	call   42d8 <init_q>
}
    44c7:	c9                   	leave  
    44c8:	c3                   	ret    
