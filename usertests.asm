...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
    1006:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    100b:	c7 44 24 04 ea 54 00 	movl   $0x54ea,0x4(%esp)
    1012:	00 
  ...
  fd = open("echo", 0);
    ...
    1022:	00 
    1023:	c7 04 24 d4 54 00 00 	movl   $0x54d4,(%esp)
  ...
  if(fd < 0){
    ...
    1038:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    103d:	c7 44 24 04 f5 54 00 	movl   $0x54f5,0x4(%esp)
    1044:	00 
  ...
  fd = open("doesnotexist", 0);
    ...
    1064:	00 
    1065:	c7 04 24 08 55 00 00 	movl   $0x5508,(%esp)
  ...
  if(fd >= 0){
    ...
    107a:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    107f:	c7 44 24 04 15 55 00 	movl   $0x5515,0x4(%esp)
    1086:	00 
  ...
  printf(stdout, "open test ok\n");
    1094:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    1099:	c7 44 24 04 33 55 00 	movl   $0x5533,0x4(%esp)
    10a0:	00 
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
    10b1:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    10b6:	c7 44 24 04 41 55 00 	movl   $0x5541,0x4(%esp)
    10bd:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
    ...
    10cd:	00 
    10ce:	c7 04 24 52 55 00 00 	movl   $0x5552,(%esp)
  ...
  if(fd >= 0){
    ...
    10e3:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    10e8:	c7 44 24 04 58 55 00 	movl   $0x5558,0x4(%esp)
    10ef:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
    1104:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    1109:	c7 44 24 04 73 55 00 	movl   $0x5573,0x4(%esp)
    1110:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    1125:	00 
    1126:	c7 44 24 04 8f 55 00 	movl   $0x558f,0x4(%esp)
    112d:	00 
    ...
    113e:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    1143:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1146:	89 54 24 08          	mov    %edx,0x8(%esp)
    114a:	c7 44 24 04 9c 55 00 	movl   $0x559c,0x4(%esp)
    1151:	00 
    ...
    1166:	00 
    1167:	c7 44 24 04 c0 55 00 	movl   $0x55c0,0x4(%esp)
    116e:	00 
    ...
    117f:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    1184:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1187:	89 54 24 08          	mov    %edx,0x8(%esp)
    118b:	c7 44 24 04 cc 55 00 	movl   $0x55cc,0x4(%esp)
    1192:	00 
  ...
  printf(stdout, "writes ok\n");
    11ae:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    11b3:	c7 44 24 04 f0 55 00 	movl   $0x55f0,0x4(%esp)
    11ba:	00 
  ...
  fd = open("small", O_RDONLY);
    ...
    11d5:	00 
    11d6:	c7 04 24 52 55 00 00 	movl   $0x5552,(%esp)
  ...
  if(fd >= 0){
    ...
    11eb:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    11f0:	c7 44 24 04 fb 55 00 	movl   $0x55fb,0x4(%esp)
    11f7:	00 
  ...
  i = read(fd, buf, 2000);
    ...
    1207:	00 
    1208:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    120f:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
    1229:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    122e:	c7 44 24 04 14 56 00 	movl   $0x5614,0x4(%esp)
    1235:	00 
  ...
  if(i == 2000){
    ...
    1243:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    1248:	c7 44 24 04 2f 56 00 	movl   $0x562f,0x4(%esp)
    124f:	00 
  ...
  if(unlink("small") < 0){
    1263:	c7 04 24 52 55 00 00 	movl   $0x5552,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
    1275:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    127a:	c7 44 24 04 42 56 00 	movl   $0x5642,0x4(%esp)
    1281:	00 
  ...
  if(unlink("small") < 0){
    ...
    128f:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    1294:	c7 44 24 04 4f 56 00 	movl   $0x564f,0x4(%esp)
    129b:	00 
  ...
  printf(stdout, "small file test ok\n");
    12a9:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    12ae:	c7 44 24 04 64 56 00 	movl   $0x5664,0x4(%esp)
    12b5:	00 
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
    12c6:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    12cb:	c7 44 24 04 78 56 00 	movl   $0x5678,0x4(%esp)
    12d2:	00 
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    12e2:	00 
    12e3:	c7 04 24 88 56 00 00 	movl   $0x5688,(%esp)
  ...
  if(fd < 0){
    ...
    12f8:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    12fd:	c7 44 24 04 8c 56 00 	movl   $0x568c,0x4(%esp)
    1304:	00 
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    1347:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    134c:	8b 55 ec             	mov    -0x14(%ebp),%edx
    134f:	89 54 24 08          	mov    %edx,0x8(%esp)
    1353:	c7 44 24 04 a6 56 00 	movl   $0x56a6,0x4(%esp)
    135a:	00 
  ...
  fd = open("big", O_RDONLY);
    ...
    1388:	00 
    1389:	c7 04 24 88 56 00 00 	movl   $0x5688,(%esp)
  ...
  if(fd < 0){
    ...
    139e:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    13a3:	c7 44 24 04 c4 56 00 	movl   $0x56c4,0x4(%esp)
    13aa:	00 
  ...
  for(;;){
    ...
    13c6:	00 
    13c7:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    13ce:	00 
    ...
    13f0:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    13f5:	8b 55 f4             	mov    -0xc(%ebp),%edx
    13f8:	89 54 24 08          	mov    %edx,0x8(%esp)
    13fc:	c7 44 24 04 dd 56 00 	movl   $0x56dd,0x4(%esp)
    1403:	00 
    ...
    141a:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    141f:	8b 55 ec             	mov    -0x14(%ebp),%edx
    1422:	89 54 24 08          	mov    %edx,0x8(%esp)
    1426:	c7 44 24 04 fa 56 00 	movl   $0x56fa,0x4(%esp)
    142d:	00 
  ...
  if(unlink("big") < 0){
    1488:	c7 04 24 88 56 00 00 	movl   $0x5688,(%esp)
    148f:	e8 d8 37 00 00       	call   4c6c <unlink>
    1494:	85 c0                	test   %eax,%eax
    1496:	79 1a                	jns    14b2 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
    1498:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    149d:	c7 44 24 04 2c 57 00 	movl   $0x572c,0x4(%esp)
    14a4:	00 
  ...
  printf(stdout, "big files ok\n");
    14b2:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    14b7:	c7 44 24 04 3f 57 00 	movl   $0x573f,0x4(%esp)
    14be:	00 
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
    14cf:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    14d4:	c7 44 24 04 50 57 00 	movl   $0x5750,0x4(%esp)
    14db:	00 
    14dc:	89 04 24             	mov    %eax,(%esp)
    14df:	e8 d9 38 00 00       	call   4dbd <printf>

  name[0] = 'a';
    14e4:	c6 05 c0 b3 00 00 61 	movb   $0x61,0xb3c0
  name[2] = '\0';
    14eb:	c6 05 c2 b3 00 00 00 	movb   $0x0,0xb3c2
  for(i = 0; i < 52; i++){
    ...
    1501:	a2 c1 b3 00 00       	mov    %al,0xb3c1
    fd = open(name, O_CREATE|O_RDWR);
    1506:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    150d:	00 
    150e:	c7 04 24 c0 b3 00 00 	movl   $0xb3c0,(%esp)
  ...
  name[0] = 'a';
    1532:	c6 05 c0 b3 00 00 61 	movb   $0x61,0xb3c0
  name[2] = '\0';
    1539:	c6 05 c2 b3 00 00 00 	movb   $0x0,0xb3c2
  for(i = 0; i < 52; i++){
    ...
    154f:	a2 c1 b3 00 00       	mov    %al,0xb3c1
    unlink(name);
    1554:	c7 04 24 c0 b3 00 00 	movl   $0xb3c0,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
    156a:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    156f:	c7 44 24 04 78 57 00 	movl   $0x5778,0x4(%esp)
    1576:	00 
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
    1587:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    158c:	c7 44 24 04 9e 57 00 	movl   $0x579e,0x4(%esp)
    1593:	00 
    1594:	89 04 24             	mov    %eax,(%esp)
    1597:	e8 21 38 00 00       	call   4dbd <printf>

  if(mkdir("dir0") < 0){
    159c:	c7 04 24 aa 57 00 00 	movl   $0x57aa,(%esp)
    15a3:	e8 dc 36 00 00       	call   4c84 <mkdir>
    15a8:	85 c0                	test   %eax,%eax
    15aa:	79 1a                	jns    15c6 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
    15ac:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    15b1:	c7 44 24 04 af 57 00 	movl   $0x57af,0x4(%esp)
    15b8:	00 
  ...
  if(chdir("dir0") < 0){
    15c6:	c7 04 24 aa 57 00 00 	movl   $0x57aa,(%esp)
    15cd:	e8 ba 36 00 00       	call   4c8c <chdir>
    15d2:	85 c0                	test   %eax,%eax
    15d4:	79 1a                	jns    15f0 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
    15d6:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    15db:	c7 44 24 04 bd 57 00 	movl   $0x57bd,0x4(%esp)
    15e2:	00 
  ...
  if(chdir("..") < 0){
    15f0:	c7 04 24 d0 57 00 00 	movl   $0x57d0,(%esp)
    15f7:	e8 90 36 00 00       	call   4c8c <chdir>
    15fc:	85 c0                	test   %eax,%eax
    15fe:	79 1a                	jns    161a <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
    1600:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    1605:	c7 44 24 04 d3 57 00 	movl   $0x57d3,0x4(%esp)
    160c:	00 
  ...
  if(unlink("dir0") < 0){
    161a:	c7 04 24 aa 57 00 00 	movl   $0x57aa,(%esp)
    1621:	e8 46 36 00 00       	call   4c6c <unlink>
    1626:	85 c0                	test   %eax,%eax
    1628:	79 1a                	jns    1644 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
    162a:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    162f:	c7 44 24 04 e4 57 00 	movl   $0x57e4,0x4(%esp)
    1636:	00 
  ...
  printf(stdout, "mkdir test\n");
    1644:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    1649:	c7 44 24 04 9e 57 00 	movl   $0x579e,0x4(%esp)
    1650:	00 
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
    1661:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    1666:	c7 44 24 04 f8 57 00 	movl   $0x57f8,0x4(%esp)
    166d:	00 
    166e:	89 04 24             	mov    %eax,(%esp)
    1671:	e8 47 37 00 00       	call   4dbd <printf>
  if(exec("echo", echoargv) < 0){
    1676:	c7 44 24 04 cc 6b 00 	movl   $0x6bcc,0x4(%esp)
    167d:	00 
    167e:	c7 04 24 d4 54 00 00 	movl   $0x54d4,(%esp)
    1685:	e8 ca 35 00 00       	call   4c54 <exec>
    168a:	85 c0                	test   %eax,%eax
    168c:	79 1a                	jns    16a8 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
    168e:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    1693:	c7 44 24 04 03 58 00 	movl   $0x5803,0x4(%esp)
    169a:	00 
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    16bf:	c7 44 24 04 15 58 00 	movl   $0x5815,0x4(%esp)
    16c6:	00 
  ...
  if(pid == 0){
    ...
    1714:	88 90 c0 93 00 00    	mov    %dl,0x93c0(%eax)
  ...
  if(pid == 0){
    ...
    1735:	00 
    1736:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    173d:	00 
    ...
    174d:	c7 44 24 04 24 58 00 	movl   $0x5824,0x4(%esp)
    1754:	00 
  ...
  if(pid == 0){
    ...
    17a6:	0f b6 80 c0 93 00 00 	movzbl 0x93c0(%eax),%eax
    ...
    17c5:	c7 44 24 04 32 58 00 	movl   $0x5832,0x4(%esp)
    17cc:	00 
    ...
    180e:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    1815:	00 
    ...
    183b:	c7 44 24 04 40 58 00 	movl   $0x5840,0x4(%esp)
    1842:	00 
  ...
  printf(1, "pipe1 ok\n");
    1864:	c7 44 24 04 57 58 00 	movl   $0x5857,0x4(%esp)
    186b:	00 
    ...
    printf(1, "fork() failed\n");
    187a:	c7 44 24 04 61 58 00 	movl   $0x5861,0x4(%esp)
    1881:	00 
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
    189b:	c7 44 24 04 70 58 00 	movl   $0x5870,0x4(%esp)
    18a2:	00 
  ...
  if(pid3 == 0){
    ...
    18fd:	00 
    18fe:	c7 44 24 04 7a 58 00 	movl   $0x587a,0x4(%esp)
    1905:	00 
    ...
    1913:	c7 44 24 04 7c 58 00 	movl   $0x587c,0x4(%esp)
    191a:	00 
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    1949:	00 
    194a:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    1951:	00 
    ...
    195f:	c7 44 24 04 90 58 00 	movl   $0x5890,0x4(%esp)
    1966:	00 
  ...
  printf(1, "kill... ");
    1980:	c7 44 24 04 a3 58 00 	movl   $0x58a3,0x4(%esp)
    1987:	00 
  ...
  printf(1, "wait... ");
    19b5:	c7 44 24 04 ac 58 00 	movl   $0x58ac,0x4(%esp)
    19bc:	00 
  ...
  printf(1, "preempt ok\n");
    19d8:	c7 44 24 04 b5 58 00 	movl   $0x58b5,0x4(%esp)
    19df:	00 
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1a09:	79 16                	jns    1a21 <exitwait+0x33>
      printf(1, "fork failed\n");
    1a0b:	c7 44 24 04 c1 58 00 	movl   $0x58c1,0x4(%esp)
    1a12:	00 
    ...
    1a31:	c7 44 24 04 ce 58 00 	movl   $0x58ce,0x4(%esp)
    1a38:	00 
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
    1a56:	c7 44 24 04 de 58 00 	movl   $0x58de,0x4(%esp)
    1a5d:	00 
...
mem(void)
{
  ...
  printf(1, "mem test\n");
    1a72:	c7 44 24 04 eb 58 00 	movl   $0x58eb,0x4(%esp)
    1a79:	00 
  ...
  if((pid = fork()) == 0){
    ...
    1b02:	c7 44 24 04 f5 58 00 	movl   $0x58f5,0x4(%esp)
    1b09:	00 
    ...
    printf(1, "mem ok\n");
    1b31:	c7 44 24 04 0f 59 00 	movl   $0x590f,0x4(%esp)
    1b38:	00 
...
sharedfd(void)
{
  ...
  if(fd < 0){
    ...
    1b94:	c7 44 24 04 30 59 00 	movl   $0x5930,0x4(%esp)
    1b9b:	00 
  ...
  for(i = 0; i < 1000; i++){
    ...
    1c06:	c7 44 24 04 5c 59 00 	movl   $0x595c,0x4(%esp)
    1c0d:	00 
  ...
  fd = open("sharedfd", 0);
    ...
    1c4b:	00 
    1c4c:	c7 04 24 26 59 00 00 	movl   $0x5926,(%esp)
  ...
  if(fd < 0){
    ...
    1c61:	c7 44 24 04 7c 59 00 	movl   $0x597c,0x4(%esp)
    1c68:	00 
  ...
  unlink("sharedfd");
    1cec:	c7 04 24 26 59 00 00 	movl   $0x5926,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    1d0a:	c7 44 24 04 a7 59 00 	movl   $0x59a7,0x4(%esp)
    1d11:	00 
  ...
  if(nc == 10000 && np == 10000){
    ...
    1d2f:	c7 44 24 04 b4 59 00 	movl   $0x59b4,0x4(%esp)
    1d36:	00 
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
    1d50:	c7 44 24 04 c9 59 00 	movl   $0x59c9,0x4(%esp)
    1d57:	00 
    1d58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d5f:	e8 59 30 00 00       	call   4dbd <printf>

  unlink("f1");
    1d64:	c7 04 24 d8 59 00 00 	movl   $0x59d8,(%esp)
    1d6b:	e8 fc 2e 00 00       	call   4c6c <unlink>
  unlink("f2");
    1d70:	c7 04 24 db 59 00 00 	movl   $0x59db,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1d8a:	c7 44 24 04 c1 58 00 	movl   $0x58c1,0x4(%esp)
    1d91:	00 
  ...
  fname = pid ? "f1" : "f2";
    ...
    1da9:	b8 d8 59 00 00       	mov    $0x59d8,%eax
    1dae:	eb 05                	jmp    1db5 <twofiles+0x6b>
    1db0:	b8 db 59 00 00       	mov    $0x59db,%eax
  ...
  if(fd < 0){
    ...
    1dd4:	c7 44 24 04 de 59 00 	movl   $0x59de,0x4(%esp)
    1ddb:	00 
  ...
  memset(buf, pid?'p':'c', 512);
    ...
    1e0b:	c7 04 24 c0 93 00 00 	movl   $0x93c0,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    1e27:	00 
    1e28:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    1e2f:	00 
    ...
    1e4e:	c7 44 24 04 ed 59 00 	movl   $0x59ed,0x4(%esp)
    1e55:	00 
  ...
  for(i = 0; i < 2; i++){
    ...
    1e9e:	b8 d8 59 00 00       	mov    $0x59d8,%eax
    1ea3:	eb 05                	jmp    1eaa <twofiles+0x160>
    1ea5:	b8 db 59 00 00       	mov    $0x59db,%eax
    ...
    1ed2:	0f b6 80 c0 93 00 00 	movzbl 0x93c0(%eax),%eax
    ...
    1ef0:	74 19                	je     1f0b <twofiles+0x1c1>
          printf(1, "wrong char\n");
    1ef2:	c7 44 24 04 fe 59 00 	movl   $0x59fe,0x4(%esp)
    1ef9:	00 
  ...
  for(i = 0; i < 2; i++){
    ...
    1f24:	00 
    1f25:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    1f2c:	00 
    ...
    1f5c:	c7 44 24 04 0a 5a 00 	movl   $0x5a0a,0x4(%esp)
    1f63:	00 
  ...
  unlink("f1");
    1f83:	c7 04 24 d8 59 00 00 	movl   $0x59d8,(%esp)
    1f8a:	e8 dd 2c 00 00       	call   4c6c <unlink>
  unlink("f2");
    1f8f:	c7 04 24 db 59 00 00 	movl   $0x59db,(%esp)
    1f96:	e8 d1 2c 00 00       	call   4c6c <unlink>

  printf(1, "twofiles ok\n");
    1f9b:	c7 44 24 04 1b 5a 00 	movl   $0x5a1b,0x4(%esp)
    1fa2:	00 
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1fb7:	c7 44 24 04 28 5a 00 	movl   $0x5a28,0x4(%esp)
    1fbe:	00 
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1fd9:	c7 44 24 04 c1 58 00 	movl   $0x58c1,0x4(%esp)
    1fe0:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    203a:	79 19                	jns    2055 <createdelete+0xa4>
      printf(1, "create failed\n");
    203c:	c7 44 24 04 de 59 00 	movl   $0x59de,0x4(%esp)
    2043:	00 
    ...
    2092:	c7 44 24 04 3b 5a 00 	movl   $0x5a3b,0x4(%esp)
    2099:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    2111:	c7 44 24 04 4c 5a 00 	movl   $0x5a4c,0x4(%esp)
    2118:	00 
    ...
    2143:	c7 44 24 04 70 5a 00 	movl   $0x5a70,0x4(%esp)
    214a:	00 
    ...
    21a9:	c7 44 24 04 4c 5a 00 	movl   $0x5a4c,0x4(%esp)
    21b0:	00 
    ...
    21db:	c7 44 24 04 70 5a 00 	movl   $0x5a70,0x4(%esp)
    21e2:	00 
  ...
  printf(1, "createdelete ok\n");
    224d:	c7 44 24 04 90 5a 00 	movl   $0x5a90,0x4(%esp)
    2254:	00 
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    2269:	c7 44 24 04 a1 5a 00 	movl   $0x5aa1,0x4(%esp)
    2270:	00 
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    2284:	00 
    2285:	c7 04 24 b2 5a 00 00 	movl   $0x5ab2,(%esp)
  ...
  if(fd < 0){
    ...
    229a:	c7 44 24 04 bd 5a 00 	movl   $0x5abd,0x4(%esp)
    22a1:	00 
  ...
  write(fd, "hello", 5);
    ...
    22ba:	00 
    22bb:	c7 44 24 04 d7 5a 00 	movl   $0x5ad7,0x4(%esp)
    22c2:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    22e0:	00 
    22e1:	c7 04 24 b2 5a 00 00 	movl   $0x5ab2,(%esp)
  ...
  if(fd < 0){
    ...
    22f6:	c7 44 24 04 dd 5a 00 	movl   $0x5add,0x4(%esp)
    22fd:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    237c:	00 
    237d:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    2384:	00 
    ...
    2395:	c7 44 24 04 13 5b 00 	movl   $0x5b13,0x4(%esp)
    239c:	00 
  ...
  if(buf[0] != 'h'){
    23ae:	0f b6 05 c0 93 00 00 	movzbl 0x93c0,%eax
    23b5:	3c 68                	cmp    $0x68,%al
    23b7:	74 19                	je     23d2 <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    23b9:	c7 44 24 04 2a 5b 00 	movl   $0x5b2a,0x4(%esp)
    23c0:	00 
  ...
  if(write(fd, buf, 10) != 10){
    ...
    23d9:	00 
    23da:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    23e1:	00 
    ...
    23f2:	c7 44 24 04 41 5b 00 	movl   $0x5b41,0x4(%esp)
    23f9:	00 
  ...
  unlink("unlinkread");
    2416:	c7 04 24 b2 5a 00 00 	movl   $0x5ab2,(%esp)
    241d:	e8 4a 28 00 00       	call   4c6c <unlink>
  printf(1, "unlinkread ok\n");
    2422:	c7 44 24 04 5a 5b 00 	movl   $0x5b5a,0x4(%esp)
    2429:	00 
...
linktest(void)
{
  ...
  if(fd < 0){
    ...
    2487:	c7 44 24 04 7b 5b 00 	movl   $0x5b7b,0x4(%esp)
    248e:	00 
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    24a7:	00 
    24a8:	c7 44 24 04 d7 5a 00 	movl   $0x5ad7,0x4(%esp)
    24af:	00 
    ...
    24c0:	c7 44 24 04 8e 5b 00 	movl   $0x5b8e,0x4(%esp)
    24c7:	00 
  ...
  if(link("lf1", "lf2") < 0){
    24e4:	c7 44 24 04 77 5b 00 	movl   $0x5b77,0x4(%esp)
    24eb:	00 
    24ec:	c7 04 24 73 5b 00 00 	movl   $0x5b73,(%esp)
    24f3:	e8 84 27 00 00       	call   4c7c <link>
    24f8:	85 c0                	test   %eax,%eax
    24fa:	79 19                	jns    2515 <linktest+0xdd>
    printf(1, "link lf1 lf2 failed\n");
    24fc:	c7 44 24 04 a0 5b 00 	movl   $0x5ba0,0x4(%esp)
    2503:	00 
  ...
  fd = open("lf2", 0);
    ...
    2559:	00 
    255a:	c7 04 24 77 5b 00 00 	movl   $0x5b77,(%esp)
  ...
  if(fd < 0){
    ...
    256f:	c7 44 24 04 dd 5b 00 	movl   $0x5bdd,0x4(%esp)
    2576:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    258f:	00 
    2590:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    2597:	00 
    ...
    25a8:	c7 44 24 04 ee 5b 00 	movl   $0x5bee,0x4(%esp)
    25af:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    25cc:	c7 44 24 04 77 5b 00 	movl   $0x5b77,0x4(%esp)
    25d3:	00 
    25d4:	c7 04 24 77 5b 00 00 	movl   $0x5b77,(%esp)
    25db:	e8 9c 26 00 00       	call   4c7c <link>
    25e0:	85 c0                	test   %eax,%eax
    25e2:	78 19                	js     25fd <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    25e4:	c7 44 24 04 ff 5b 00 	movl   $0x5bff,0x4(%esp)
    25eb:	00 
  ...
  unlink("lf2");
    25fd:	c7 04 24 77 5b 00 00 	movl   $0x5b77,(%esp)
    2604:	e8 63 26 00 00       	call   4c6c <unlink>
  if(link("lf2", "lf1") >= 0){
    2609:	c7 44 24 04 73 5b 00 	movl   $0x5b73,0x4(%esp)
    2610:	00 
    2611:	c7 04 24 77 5b 00 00 	movl   $0x5b77,(%esp)
    2618:	e8 5f 26 00 00       	call   4c7c <link>
    261d:	85 c0                	test   %eax,%eax
    261f:	78 19                	js     263a <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    2621:	c7 44 24 04 20 5c 00 	movl   $0x5c20,0x4(%esp)
    2628:	00 
  ...
  if(link(".", "lf1") >= 0){
    263a:	c7 44 24 04 73 5b 00 	movl   $0x5b73,0x4(%esp)
    2641:	00 
    2642:	c7 04 24 43 5c 00 00 	movl   $0x5c43,(%esp)
    2649:	e8 2e 26 00 00       	call   4c7c <link>
    264e:	85 c0                	test   %eax,%eax
    2650:	78 19                	js     266b <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    2652:	c7 44 24 04 45 5c 00 	movl   $0x5c45,0x4(%esp)
    2659:	00 
  ...
  printf(1, "linktest ok\n");
    266b:	c7 44 24 04 61 5c 00 	movl   $0x5c61,0x4(%esp)
    2672:	00 
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    2687:	c7 44 24 04 6e 5c 00 	movl   $0x5c6e,0x4(%esp)
    268e:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    26fa:	c7 04 24 7e 5c 00 00 	movl   $0x5c7e,(%esp)
  ...
  for(i = 0; i < 40; i++){
    ...
    273d:	c7 04 24 7e 5c 00 00 	movl   $0x5c7e,(%esp)
    ...
    276e:	c7 44 24 04 81 5c 00 	movl   $0x5c81,0x4(%esp)
    2775:	00 
  ...
  fd = open(".", 0);
    ...
    27d2:	00 
    27d3:	c7 04 24 43 5c 00 00 	movl   $0x5c43,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    2834:	c7 44 24 04 9d 5c 00 	movl   $0x5c9d,0x4(%esp)
    283b:	00 
    ...
    2863:	c7 44 24 04 b6 5c 00 	movl   $0x5cb6,0x4(%esp)
    286a:	00 
  ...
  if(n != 40){
    ...
    28be:	c7 44 24 04 d4 5c 00 	movl   $0x5cd4,0x4(%esp)
    28c5:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    28f8:	79 19                	jns    2913 <concreate+0x292>
      printf(1, "fork failed\n");
    28fa:	c7 44 24 04 c1 58 00 	movl   $0x58c1,0x4(%esp)
    2901:	00 
  ...
  printf(1, "concreate ok\n");
    2a1a:	c7 44 24 04 05 5d 00 	movl   $0x5d05,0x4(%esp)
    2a21:	00 
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    2a36:	c7 44 24 04 13 5d 00 	movl   $0x5d13,0x4(%esp)
    2a3d:	00 
    2a3e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a45:	e8 73 23 00 00       	call   4dbd <printf>

  unlink("x");
    2a4a:	c7 04 24 7a 58 00 00 	movl   $0x587a,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    2a64:	c7 44 24 04 c1 58 00 	movl   $0x58c1,0x4(%esp)
    2a6b:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    2ad2:	00 
    2ad3:	c7 04 24 7a 58 00 00 	movl   $0x587a,(%esp)
    ...
    2b04:	75 16                	jne    2b1c <linkunlink+0xec>
      link("cat", "x");
    2b06:	c7 44 24 04 7a 58 00 	movl   $0x587a,0x4(%esp)
    2b0d:	00 
    2b0e:	c7 04 24 24 5d 00 00 	movl   $0x5d24,(%esp)
    2b15:	e8 62 21 00 00       	call   4c7c <link>
    2b1a:	eb 0c                	jmp    2b28 <linkunlink+0xf8>
    } else {
      unlink("x");
    2b1c:	c7 04 24 7a 58 00 00 	movl   $0x587a,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    2b41:	c7 44 24 04 28 5d 00 	movl   $0x5d28,0x4(%esp)
    2b48:	00 
...
bigdir(void)
{
  ...
  if(fd < 0){
    ...
    2b9f:	c7 44 24 04 47 5d 00 	movl   $0x5d47,0x4(%esp)
    2ba6:	00 
  ...
  unlink("bd");
    2c3d:	c7 04 24 44 5d 00 00 	movl   $0x5d44,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    2c95:	c7 44 24 04 71 5d 00 	movl   $0x5d71,0x4(%esp)
    2c9c:	00 
  ...
  printf(1, "bigdir ok\n");
    2cbb:	c7 44 24 04 86 5d 00 	movl   $0x5d86,0x4(%esp)
    2cc2:	00 
...
subdir(void)
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2d27:	00 
    2d28:	c7 04 24 bc 5d 00 00 	movl   $0x5dbc,(%esp)
  ...
  if(fd < 0){
    ...
    2d3d:	c7 44 24 04 c2 5d 00 	movl   $0x5dc2,0x4(%esp)
    2d44:	00 
  ...
  write(fd, "ff", 2);
    ...
    2d5d:	00 
    2d5e:	c7 44 24 04 9e 5d 00 	movl   $0x5d9e,0x4(%esp)
    2d65:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2dd5:	00 
    2dd6:	c7 04 24 20 5e 00 00 	movl   $0x5e20,(%esp)
  ...
  if(fd < 0){
    ...
    2deb:	c7 44 24 04 29 5e 00 	movl   $0x5e29,0x4(%esp)
    2df2:	00 
  ...
  write(fd, "FF", 2);
    ...
    2e0b:	00 
    2e0c:	c7 44 24 04 41 5e 00 	movl   $0x5e41,0x4(%esp)
    2e13:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2e31:	00 
    2e32:	c7 04 24 44 5e 00 00 	movl   $0x5e44,(%esp)
  ...
  if(fd < 0){
    ...
    2e47:	c7 44 24 04 50 5e 00 	movl   $0x5e50,0x4(%esp)
    2e4e:	00 
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2e67:	00 
    2e68:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    2e6f:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2e84:	0f b6 05 c0 93 00 00 	movzbl 0x93c0,%eax
    2e8b:	3c 66                	cmp    $0x66,%al
    2e8d:	74 19                	je     2ea8 <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    2e8f:	c7 44 24 04 69 5e 00 	movl   $0x5e69,0x4(%esp)
    2e96:	00 
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    2eb3:	c7 44 24 04 84 5e 00 	movl   $0x5e84,0x4(%esp)
    2eba:	00 
    2ebb:	c7 04 24 20 5e 00 00 	movl   $0x5e20,(%esp)
    2ec2:	e8 b5 1d 00 00       	call   4c7c <link>
    2ec7:	85 c0                	test   %eax,%eax
    2ec9:	74 19                	je     2ee4 <subdir+0x213>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2ecb:	c7 44 24 04 90 5e 00 	movl   $0x5e90,0x4(%esp)
    2ed2:	00 
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    2fe9:	00 
    2fea:	c7 04 24 84 5e 00 00 	movl   $0x5e84,(%esp)
  ...
  if(fd < 0){
    ...
    2fff:	c7 44 24 04 4e 5f 00 	movl   $0x5f4e,0x4(%esp)
    3006:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    301f:	00 
    3020:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    3027:	00 
    ...
    3038:	c7 44 24 04 66 5f 00 	movl   $0x5f66,0x4(%esp)
    303f:	00 
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    3182:	c7 44 24 04 3d 60 00 	movl   $0x603d,0x4(%esp)
    3189:	00 
    318a:	c7 04 24 a9 5f 00 00 	movl   $0x5fa9,(%esp)
    3191:	e8 e6 1a 00 00       	call   4c7c <link>
    3196:	85 c0                	test   %eax,%eax
    3198:	75 19                	jne    31b3 <subdir+0x4e2>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    319a:	c7 44 24 04 48 60 00 	movl   $0x6048,0x4(%esp)
    31a1:	00 
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    31b3:	c7 44 24 04 3d 60 00 	movl   $0x603d,0x4(%esp)
    31ba:	00 
    31bb:	c7 04 24 ce 5f 00 00 	movl   $0x5fce,(%esp)
    31c2:	e8 b5 1a 00 00       	call   4c7c <link>
    31c7:	85 c0                	test   %eax,%eax
    31c9:	75 19                	jne    31e4 <subdir+0x513>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    31cb:	c7 44 24 04 6c 60 00 	movl   $0x606c,0x4(%esp)
    31d2:	00 
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    31e4:	c7 44 24 04 84 5e 00 	movl   $0x5e84,0x4(%esp)
    31eb:	00 
    31ec:	c7 04 24 bc 5d 00 00 	movl   $0x5dbc,(%esp)
    31f3:	e8 84 1a 00 00       	call   4c7c <link>
    31f8:	85 c0                	test   %eax,%eax
    31fa:	75 19                	jne    3215 <subdir+0x544>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    31fc:	c7 44 24 04 90 60 00 	movl   $0x6090,0x4(%esp)
    3203:	00 
  ...
  printf(1, "subdir ok\n");
    3401:	c7 44 24 04 d5 61 00 	movl   $0x61d5,0x4(%esp)
    3408:	00 
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    341d:	c7 44 24 04 e0 61 00 	movl   $0x61e0,0x4(%esp)
    3424:	00 
    3425:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    342c:	e8 8c 19 00 00       	call   4dbd <printf>

  unlink("bigwrite");
    3431:	c7 04 24 ef 61 00 00 	movl   $0x61ef,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    3450:	00 
    3451:	c7 04 24 ef 61 00 00 	movl   $0x61ef,(%esp)
    ...
    3466:	c7 44 24 04 f8 61 00 	movl   $0x61f8,0x4(%esp)
    346d:	00 
    ...
    348f:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    3496:	00 
    ...
    34bb:	c7 44 24 04 10 62 00 	movl   $0x6210,0x4(%esp)
    34c2:	00 
    ...
    unlink("bigwrite");
    34e9:	c7 04 24 ef 61 00 00 	movl   $0x61ef,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    3509:	c7 44 24 04 22 62 00 	movl   $0x6222,0x4(%esp)
    3510:	00 
...
bigfile(void)
{
  ...
  if(fd < 0){
    ...
    3562:	c7 44 24 04 45 62 00 	movl   $0x6245,0x4(%esp)
    3569:	00 
  ...
  for(i = 0; i < 20; i++){
    ...
    3593:	c7 04 24 c0 93 00 00 	movl   $0x93c0,(%esp)
    359a:	e8 d7 14 00 00       	call   4a76 <memset>
    if(write(fd, buf, 600) != 600){
    359f:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    35a6:	00 
    35a7:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    35ae:	00 
    ...
    35c1:	c7 44 24 04 5b 62 00 	movl   $0x625b,0x4(%esp)
    35c8:	00 
  ...
  fd = open("bigfile", 0);
    ...
    35f6:	00 
    35f7:	c7 04 24 3d 62 00 00 	movl   $0x623d,(%esp)
  ...
  if(fd < 0){
    ...
    360c:	c7 44 24 04 71 62 00 	movl   $0x6271,0x4(%esp)
    3613:	00 
  ...
  for(i = 0; ; i++){
    ...
    363a:	00 
    363b:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    3642:	00 
    ...
    3657:	c7 44 24 04 86 62 00 	movl   $0x6286,0x4(%esp)
    365e:	00 
    ...
    3683:	c7 44 24 04 9b 62 00 	movl   $0x629b,0x4(%esp)
    368a:	00 
    ...
    369c:	0f b6 05 c0 93 00 00 	movzbl 0x93c0,%eax
    ...
    36b7:	0f b6 05 eb 94 00 00 	movzbl 0x94eb,%eax
    ...
    36d2:	c7 44 24 04 af 62 00 	movl   $0x62af,0x4(%esp)
    36d9:	00 
  ...
  if(total != 20*600){
    ...
    370f:	c7 44 24 04 c8 62 00 	movl   $0x62c8,0x4(%esp)
    3716:	00 
  ...
  unlink("bigfile");
    3728:	c7 04 24 3d 62 00 00 	movl   $0x623d,(%esp)
    372f:	e8 38 15 00 00       	call   4c6c <unlink>

  printf(1, "bigfile test ok\n");
    3734:	c7 44 24 04 e2 62 00 	movl   $0x62e2,0x4(%esp)
    373b:	00 
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    37bd:	00 
    37be:	c7 04 24 80 63 00 00 	movl   $0x6380,(%esp)
  ...
  if(fd < 0){
    ...
    37d3:	c7 44 24 04 b0 63 00 	movl   $0x63b0,0x4(%esp)
    37da:	00 
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    37fe:	00 
    37ff:	c7 04 24 f0 63 00 00 	movl   $0x63f0,(%esp)
  ...
  if(fd < 0){
    ...
    3814:	c7 44 24 04 20 64 00 	movl   $0x6420,0x4(%esp)
    381b:	00 
  ...
  printf(1, "fourteen ok\n");
    388a:	c7 44 24 04 f9 64 00 	movl   $0x64f9,0x4(%esp)
    3891:	00 
...
rmdot(void)
{
  ...
  printf(1, "rmdot ok\n");
    3a02:	c7 44 24 04 bf 65 00 	movl   $0x65bf,0x4(%esp)
    3a09:	00 
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    3a1e:	c7 44 24 04 c9 65 00 	movl   $0x65c9,0x4(%esp)
    3a25:	00 
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3a39:	00 
    3a3a:	c7 04 24 d6 65 00 00 	movl   $0x65d6,(%esp)
  ...
  if(fd < 0){
    ...
    3a4f:	c7 44 24 04 de 65 00 	movl   $0x65de,0x4(%esp)
    3a56:	00 
  ...
  fd = open("dirfile/xx", 0);
    ...
    3aa3:	00 
    3aa4:	c7 04 24 0f 66 00 00 	movl   $0x660f,(%esp)
  ...
  if(fd >= 0){
    ...
    3ab9:	c7 44 24 04 1a 66 00 	movl   $0x661a,0x4(%esp)
    3ac0:	00 
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3ad9:	00 
    3ada:	c7 04 24 0f 66 00 00 	movl   $0x660f,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(1, "create dirfile/xx succeeded!\n");
    3aef:	c7 44 24 04 1a 66 00 	movl   $0x661a,0x4(%esp)
    3af6:	00 
  ...
  if(link("README", "dirfile/xx") == 0){
    3b5a:	c7 44 24 04 0f 66 00 	movl   $0x660f,0x4(%esp)
    3b61:	00 
    3b62:	c7 04 24 73 66 00 00 	movl   $0x6673,(%esp)
    3b69:	e8 0e 11 00 00       	call   4c7c <link>
    3b6e:	85 c0                	test   %eax,%eax
    3b70:	75 19                	jne    3b8b <dirfile+0x173>
    printf(1, "link to dirfile/xx succeeded!\n");
    3b72:	c7 44 24 04 7c 66 00 	movl   $0x667c,0x4(%esp)
    3b79:	00 
  ...
  fd = open(".", O_RDWR);
    ...
    3bbb:	00 
    3bbc:	c7 04 24 43 5c 00 00 	movl   $0x5c43,(%esp)
  ...
  if(fd >= 0){
    ...
    3bd1:	c7 44 24 04 b4 66 00 	movl   $0x66b4,0x4(%esp)
    3bd8:	00 
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c20:	c7 44 24 04 d3 66 00 	movl   $0x66d3,0x4(%esp)
    3c27:	00 
  ...
  printf(1, "dir vs file OK\n");
    3c44:	c7 44 24 04 e7 66 00 	movl   $0x66e7,0x4(%esp)
    3c4b:	00 
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    3c60:	c7 44 24 04 f7 66 00 	movl   $0x66f7,0x4(%esp)
    3c67:	00 
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    mkdir("");
    3cd2:	c7 04 24 36 67 00 00 	movl   $0x6736,(%esp)
    3cd9:	e8 a6 0f 00 00       	call   4c84 <mkdir>
    link("README", "");
    3cde:	c7 44 24 04 36 67 00 	movl   $0x6736,0x4(%esp)
    3ce5:	00 
    3ce6:	c7 04 24 73 66 00 00 	movl   $0x6673,(%esp)
    3ced:	e8 8a 0f 00 00       	call   4c7c <link>
    fd = open("", O_CREATE);
    3cf2:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3cf9:	00 
    3cfa:	c7 04 24 36 67 00 00 	movl   $0x6736,(%esp)
    ...
    3d21:	00 
    3d22:	c7 04 24 37 67 00 00 	movl   $0x6737,(%esp)
    ...
    unlink("xx");
    3d42:	c7 04 24 37 67 00 00 	movl   $0x6737,(%esp)
  ...
  chdir("/");
    3d5c:	c7 04 24 5a 65 00 00 	movl   $0x655a,(%esp)
    3d63:	e8 24 0f 00 00       	call   4c8c <chdir>
  printf(1, "empty file name OK\n");
    3d68:	c7 44 24 04 3a 67 00 	movl   $0x673a,0x4(%esp)
    3d6f:	00 
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3d84:	c7 44 24 04 4e 67 00 	movl   $0x674e,0x4(%esp)
    3d8b:	00 
    ...
    3db5:	e8 62 0e 00 00       	call   4c1c <exit>
{
  ...
  if(n == 1000){
    ...
    3dd3:	c7 44 24 04 5c 67 00 	movl   $0x675c,0x4(%esp)
    3dda:	00 
  ...
  for(; n > 0; n--){
    ...
    3df5:	c7 44 24 04 7e 67 00 	movl   $0x677e,0x4(%esp)
    3dfc:	00 
  ...
  if(wait() != -1){
    ...
    3e22:	c7 44 24 04 92 67 00 	movl   $0x6792,0x4(%esp)
    3e29:	00 
  ...
  printf(1, "fork test OK\n");
    3e3b:	c7 44 24 04 a5 67 00 	movl   $0x67a5,0x4(%esp)
    3e42:	00 
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    3e5b:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    3e60:	c7 44 24 04 b3 67 00 	movl   $0x67b3,0x4(%esp)
    3e67:	00 
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    3eae:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    ...
    3ec8:	c7 44 24 04 be 67 00 	movl   $0x67be,0x4(%esp)
    3ecf:	00 
  ...
  if(pid < 0){
    ...
    3f07:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    3f0c:	c7 44 24 04 d9 67 00 	movl   $0x67d9,0x4(%esp)
    3f13:	00 
  ...
  if(c != a + 1){
    ...
    3f4a:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    3f4f:	c7 44 24 04 f0 67 00 	movl   $0x67f0,0x4(%esp)
    3f56:	00 
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    3faa:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    3faf:	c7 44 24 04 0c 68 00 	movl   $0x680c,0x4(%esp)
    3fb6:	00 
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3ff5:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    3ffa:	c7 44 24 04 4a 68 00 	movl   $0x684a,0x4(%esp)
    4001:	00 
  ...
  if(c != a - 4096){
    ...
    402b:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    ...
    403e:	c7 44 24 04 68 68 00 	movl   $0x6868,0x4(%esp)
    4045:	00 
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    4092:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    ...
    40a5:	c7 44 24 04 a0 68 00 	movl   $0x68a0,0x4(%esp)
    40ac:	00 
  ...
  if(*lastaddr == 99){
    ...
    40c4:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    40c9:	c7 44 24 04 c8 68 00 	movl   $0x68c8,0x4(%esp)
    40d0:	00 
  ...
  if(c != a){
    ...
    4115:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    ...
    4128:	c7 44 24 04 f8 68 00 	movl   $0x68f8,0x4(%esp)
    412f:	00 
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    415c:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    4161:	c7 44 24 04 c1 58 00 	movl   $0x58c1,0x4(%esp)
    4168:	00 
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    41dd:	c7 44 24 04 15 58 00 	movl   $0x5815,0x4(%esp)
    41e4:	00 
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    423f:	00 
    4240:	c7 44 24 04 7a 58 00 	movl   $0x587a,0x4(%esp)
    4247:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    42e1:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    42e6:	c7 44 24 04 32 69 00 	movl   $0x6932,0x4(%esp)
    42ed:	00 
  ...
  printf(stdout, "sbrk test OK\n");
    4329:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    432e:	c7 44 24 04 4d 69 00 	movl   $0x694d,0x4(%esp)
    4335:	00 
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    436f:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    4374:	c7 44 24 04 5b 69 00 	movl   $0x695b,0x4(%esp)
    437b:	00 
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    43e1:	c7 04 24 6a 69 00 00 	movl   $0x696a,(%esp)
    43e8:	e8 8f 08 00 00       	call   4c7c <link>
    43ed:	83 f8 ff             	cmp    $0xffffffff,%eax
    43f0:	74 1a                	je     440c <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    43f2:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    43f7:	c7 44 24 04 75 69 00 	movl   $0x6975,0x4(%esp)
    43fe:	00 
  ...
  printf(stdout, "validate ok\n");
    441f:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    4424:	c7 44 24 04 8e 69 00 	movl   $0x698e,0x4(%esp)
    442b:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    443c:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    4441:	c7 44 24 04 9b 69 00 	movl   $0x699b,0x4(%esp)
    4448:	00 
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    445d:	0f b6 80 a0 6c 00 00 	movzbl 0x6ca0(%eax),%eax
    4464:	84 c0                	test   %al,%al
    4466:	74 1a                	je     4482 <bsstest+0x4c>
      printf(stdout, "bss test failed\n");
    4468:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    446d:	c7 44 24 04 a5 69 00 	movl   $0x69a5,0x4(%esp)
    4474:	00 
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    4490:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    4495:	c7 44 24 04 b6 69 00 	movl   $0x69b6,0x4(%esp)
    449c:	00 
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    44ad:	c7 04 24 c3 69 00 00 	movl   $0x69c3,(%esp)
  ...
  if(pid == 0){
    ...
    44d7:	c7 04 85 00 6c 00 00 	movl   $0x69d0,0x6c00(,%eax,4)
    44de:	d0 69 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    44ea:	7e e8                	jle    44d4 <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    44ec:	c7 05 7c 6c 00 00 00 	movl   $0x0,0x6c7c
    44f3:	00 00 00 
    printf(stdout, "bigarg test\n");
    44f6:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    44fb:	c7 44 24 04 ad 6a 00 	movl   $0x6aad,0x4(%esp)
    4502:	00 
    4503:	89 04 24             	mov    %eax,(%esp)
    4506:	e8 b2 08 00 00       	call   4dbd <printf>
    exec("echo", args);
    450b:	c7 44 24 04 00 6c 00 	movl   $0x6c00,0x4(%esp)
    4512:	00 
    4513:	c7 04 24 d4 54 00 00 	movl   $0x54d4,(%esp)
    451a:	e8 35 07 00 00       	call   4c54 <exec>
    printf(stdout, "bigarg test ok\n");
    451f:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    4524:	c7 44 24 04 ba 6a 00 	movl   $0x6aba,0x4(%esp)
    452b:	00 
    ...
    453b:	00 
    453c:	c7 04 24 c3 69 00 00 	movl   $0x69c3,(%esp)
    ...
    4561:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    4566:	c7 44 24 04 ca 6a 00 	movl   $0x6aca,0x4(%esp)
    456d:	00 
  ...
  fd = open("bigarg-ok", 0);
    ...
    4587:	00 
    4588:	c7 04 24 c3 69 00 00 	movl   $0x69c3,(%esp)
  ...
  if(fd < 0){
    ...
    459d:	a1 e0 6b 00 00       	mov    0x6be0,%eax
    45a2:	c7 44 24 04 e3 6a 00 	movl   $0x6ae3,0x4(%esp)
    45a9:	00 
  ...
  unlink("bigarg-ok");
    45c2:	c7 04 24 c3 69 00 00 	movl   $0x69c3,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    45de:	c7 44 24 04 f8 6a 00 	movl   $0x6af8,0x4(%esp)
    45e5:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    46ce:	c7 44 24 04 05 6b 00 	movl   $0x6b05,0x4(%esp)
    46d5:	00 
    ...
    4705:	c7 44 24 04 11 6b 00 	movl   $0x6b11,0x4(%esp)
    470c:	00 
    ...
    4729:	00 
    472a:	c7 44 24 04 c0 93 00 	movl   $0x93c0,0x4(%esp)
    4731:	00 
    ...
    475d:	c7 44 24 04 21 6b 00 	movl   $0x6b21,0x4(%esp)
    4764:	00 
  ...
  printf(1, "fsfull test finished\n");
    4879:	c7 44 24 04 31 6b 00 	movl   $0x6b31,0x4(%esp)
    4880:	00 
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    4896:	a1 e4 6b 00 00       	mov    0x6be4,%eax
    489b:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    48a1:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    48a6:	a3 e4 6b 00 00       	mov    %eax,0x6be4
  return randstate;
    48ab:	a1 e4 6b 00 00       	mov    0x6be4,%eax
}
    48b0:	5d                   	pop    %ebp
    48b1:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    48bb:	c7 44 24 04 47 6b 00 	movl   $0x6b47,0x4(%esp)
    48c2:	00 
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    4907:	00 
    4908:	c7 04 24 5b 6b 00 00 	movl   $0x6b5b,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    4d56:	0f b6 80 e8 6b 00 00 	movzbl 0x6be8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4eb4:	75 27                	jne    4edd <printf+0x120>
          s = "(null)";
    4eb6:	c7 45 e4 96 6b 00 00 	movl   $0x6b96,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4f83:	a1 88 6c 00 00       	mov    0x6c88,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    5044:	a3 88 6c 00 00       	mov    %eax,0x6c88
}
    5049:	c9                   	leave  
    504a:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    509c:	a1 88 6c 00 00       	mov    0x6c88,%eax
}
    50a1:	c9                   	leave  
    50a2:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    50b8:	a1 88 6c 00 00       	mov    0x6c88,%eax
    50bd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    50c0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    50c4:	75 23                	jne    50e9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    50c6:	c7 45 f0 80 6c 00 00 	movl   $0x6c80,-0x10(%ebp)
    50cd:	8b 45 f0             	mov    -0x10(%ebp),%eax
    50d0:	a3 88 6c 00 00       	mov    %eax,0x6c88
    50d5:	a1 88 6c 00 00       	mov    0x6c88,%eax
    50da:	a3 80 6c 00 00       	mov    %eax,0x6c80
    base.s.size = 0;
    50df:	c7 05 84 6c 00 00 00 	movl   $0x0,0x6c84
    50e6:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    513c:	a3 88 6c 00 00       	mov    %eax,0x6c88
      return (void*)(p + 1);
    ...
    if(p == freep)
    5149:	a1 88 6c 00 00       	mov    0x6c88,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    5228:	c7 44 24 04 9d 6b 00 	movl   $0x6b9d,0x4(%esp)
    522f:	00 
    ...
    526d:	c7 44 24 04 ab 6b 00 	movl   $0x6bab,0x4(%esp)
    5274:	00 
    ...
    5299:	c7 44 24 04 b8 6b 00 	movl   $0x6bb8,0x4(%esp)
    52a0:	00 
...
int random(int max){
    ...
    52b7:	a1 fc 6b 00 00       	mov    0x6bfc,%eax
    52bc:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    52c2:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    52c7:	a3 fc 6b 00 00       	mov    %eax,0x6bfc
    return (int)(rands % max);
    52cc:	a1 fc 6b 00 00       	mov    0x6bfc,%eax
...
void sem_acquire(struct Semaphore *s) 
{
	...
	lock_acquire(&s->lock);
    53fe:	8b 45 08             	mov    0x8(%ebp),%eax
    5401:	89 04 24             	mov    %eax,(%esp)
    5404:	e8 a3 fd ff ff       	call   51ac <lock_acquire>
	s->count--; 
    5409:	8b 45 08             	mov    0x8(%ebp),%eax
    540c:	8b 40 04             	mov    0x4(%eax),%eax
    540f:	8d 50 ff             	lea    -0x1(%eax),%edx
    5412:	8b 45 08             	mov    0x8(%ebp),%eax
    5415:	89 50 04             	mov    %edx,0x4(%eax)
	if( s->count < 0) 
    5418:	8b 45 08             	mov    0x8(%ebp),%eax
    541b:	8b 40 04             	mov    0x4(%eax),%eax
    541e:	85 c0                	test   %eax,%eax
    5420:	79 27                	jns    5449 <sem_acquire+0x51>
	{
		add_q(&s->q, getpid()); 
    5422:	e8 75 f8 ff ff       	call   4c9c <getpid>
    5427:	8b 55 08             	mov    0x8(%ebp),%edx
    542a:	83 c2 08             	add    $0x8,%edx
    542d:	89 44 24 04          	mov    %eax,0x4(%esp)
    5431:	89 14 24             	mov    %edx,(%esp)
    5434:	e8 c9 fe ff ff       	call   5302 <add_q>
		lock_release(&s->lock); 
    5439:	8b 45 08             	mov    0x8(%ebp),%eax
    543c:	89 04 24             	mov    %eax,(%esp)
    543f:	e8 87 fd ff ff       	call   51cb <lock_release>
		tsleep(); 
    5444:	e8 83 f8 ff ff       	call   4ccc <tsleep>
	} 
	lock_release(&s->lock); 
    5449:	8b 45 08             	mov    0x8(%ebp),%eax
    544c:	89 04 24             	mov    %eax,(%esp)
    544f:	e8 77 fd ff ff       	call   51cb <lock_release>
}
    5454:	c9                   	leave  
    5455:	c3                   	ret    
...
{ 
    5456:	55                   	push   %ebp
    5457:	89 e5                	mov    %esp,%ebp
    5459:	83 ec 28             	sub    $0x28,%esp
	lock_acquire(&s->lock);
    545c:	8b 45 08             	mov    0x8(%ebp),%eax
    545f:	89 04 24             	mov    %eax,(%esp)
    5462:	e8 45 fd ff ff       	call   51ac <lock_acquire>
	s->count++; 
    5467:	8b 45 08             	mov    0x8(%ebp),%eax
    546a:	8b 40 04             	mov    0x4(%eax),%eax
    546d:	8d 50 01             	lea    0x1(%eax),%edx
    5470:	8b 45 08             	mov    0x8(%ebp),%eax
    5473:	89 50 04             	mov    %edx,0x4(%eax)
	if( s->count <= 0) 
    5476:	8b 45 08             	mov    0x8(%ebp),%eax
    5479:	8b 40 04             	mov    0x4(%eax),%eax
    547c:	85 c0                	test   %eax,%eax
    547e:	7f 1c                	jg     549c <sem_signal+0x46>
	{
		int tid = pop_q(&s->q); 
    5480:	8b 45 08             	mov    0x8(%ebp),%eax
    5483:	83 c0 08             	add    $0x8,%eax
    5486:	89 04 24             	mov    %eax,(%esp)
    5489:	e8 ee fe ff ff       	call   537c <pop_q>
    548e:	89 45 f4             	mov    %eax,-0xc(%ebp)
		twakeup(tid); 
    5491:	8b 45 f4             	mov    -0xc(%ebp),%eax
    5494:	89 04 24             	mov    %eax,(%esp)
    5497:	e8 38 f8 ff ff       	call   4cd4 <twakeup>
	}
	lock_release(&s->lock); 
    549c:	8b 45 08             	mov    0x8(%ebp),%eax
    549f:	89 04 24             	mov    %eax,(%esp)
    54a2:	e8 24 fd ff ff       	call   51cb <lock_release>
} 
    54a7:	c9                   	leave  
    54a8:	c3                   	ret    
...
void sem_init(struct Semaphore *s, int size){
    54a9:	55                   	push   %ebp
    54aa:	89 e5                	mov    %esp,%ebp
    54ac:	83 ec 18             	sub    $0x18,%esp
	lock_init(&s->lock);
    54af:	8b 45 08             	mov    0x8(%ebp),%eax
    54b2:	89 04 24             	mov    %eax,(%esp)
    54b5:	e8 e4 fc ff ff       	call   519e <lock_init>
	s->count = size; 
    54ba:	8b 45 08             	mov    0x8(%ebp),%eax
    54bd:	8b 55 0c             	mov    0xc(%ebp),%edx
    54c0:	89 50 04             	mov    %edx,0x4(%eax)
	init_q(&s->q);
    54c3:	8b 45 08             	mov    0x8(%ebp),%eax
    54c6:	83 c0 08             	add    $0x8,%eax
    54c9:	89 04 24             	mov    %eax,(%esp)
    54cc:	e8 0f fe ff ff       	call   52e0 <init_q>
}
    54d1:	c9                   	leave  
    54d2:	c3                   	ret    
