...
cat(int fd)
{
  ...
  4d:	c7 44 24 04 21 0c 00 	movl   $0xc21,0x4(%esp)
  54:	00 
...
main(int argc, char *argv[])
{
  ...
  c9:	c7 44 24 04 32 0c 00 	movl   $0xc32,0x4(%esp)
  d0:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a6:	0f b6 80 7c 0c 00 00 	movzbl 0xc7c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 604:	75 27                	jne    62d <printf+0x120>
          s = "(null)";
 606:	c7 45 e4 47 0c 00 00 	movl   $0xc47,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d3:	a1 a8 0c 00 00       	mov    0xca8,%eax
...
free(void *ap)
{
 ...
 794:	a3 a8 0c 00 00       	mov    %eax,0xca8
}
 799:	c9                   	leave  
 79a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7e7:	e8 d8 fe ff ff       	call   6c4 <free>
  return freep;
 7ec:	a1 a8 0c 00 00       	mov    0xca8,%eax
}
 7f1:	c9                   	leave  
 7f2:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 805:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 808:	a1 a8 0c 00 00       	mov    0xca8,%eax
 80d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 810:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 814:	75 23                	jne    839 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 816:	c7 45 f0 a0 0c 00 00 	movl   $0xca0,-0x10(%ebp)
 81d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 820:	a3 a8 0c 00 00       	mov    %eax,0xca8
 825:	a1 a8 0c 00 00       	mov    0xca8,%eax
 82a:	a3 a0 0c 00 00       	mov    %eax,0xca0
    base.s.size = 0;
 82f:	c7 05 a4 0c 00 00 00 	movl   $0x0,0xca4
 836:	00 00 00 
  }
 ...
 88c:	a3 a8 0c 00 00       	mov    %eax,0xca8
      return (void*)(p + 1);
 ...
 897:	eb 38                	jmp    8d1 <malloc+0xde>
    ...
    if(p == freep)
 899:	a1 a8 0c 00 00       	mov    0xca8,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 978:	c7 44 24 04 4e 0c 00 	movl   $0xc4e,0x4(%esp)
 97f:	00 
 ...
 9bd:	c7 44 24 04 5c 0c 00 	movl   $0xc5c,0x4(%esp)
 9c4:	00 
 ...
 9e9:	c7 44 24 04 69 0c 00 	movl   $0xc69,0x4(%esp)
 9f0:	00 
...
int random(int max){
 ...
 a07:	a1 90 0c 00 00       	mov    0xc90,%eax
 a0c:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 a12:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 a17:	a3 90 0c 00 00       	mov    %eax,0xc90
    return (int)(rands % max);
 a1c:	a1 90 0c 00 00       	mov    0xc90,%eax
...
void sem_acquire(struct Semaphore *s) 
{
 ...
 b54:	e8 a3 fd ff ff       	call   8fc <lock_acquire>
	if( s->count-- < 0) 
 b59:	8b 45 08             	mov    0x8(%ebp),%eax
 b5c:	8b 40 04             	mov    0x4(%eax),%eax
 b5f:	89 c2                	mov    %eax,%edx
 b61:	c1 ea 1f             	shr    $0x1f,%edx
 b64:	8d 48 ff             	lea    -0x1(%eax),%ecx
 b67:	8b 45 08             	mov    0x8(%ebp),%eax
 b6a:	89 48 04             	mov    %ecx,0x4(%eax)
 b6d:	84 d2                	test   %dl,%dl
 b6f:	74 27                	je     b98 <sem_acquire+0x50>
	{
		add_q(&s->q, getpid()); 
 b71:	e8 7e f8 ff ff       	call   3f4 <getpid>
 b76:	8b 55 08             	mov    0x8(%ebp),%edx
 b79:	83 c2 08             	add    $0x8,%edx
 b7c:	89 44 24 04          	mov    %eax,0x4(%esp)
 b80:	89 14 24             	mov    %edx,(%esp)
 b83:	e8 ca fe ff ff       	call   a52 <add_q>
		lock_release(&s->lock); 
 b88:	8b 45 08             	mov    0x8(%ebp),%eax
 b8b:	89 04 24             	mov    %eax,(%esp)
 b8e:	e8 88 fd ff ff       	call   91b <lock_release>
		tsleep(); 
 b93:	e8 8c f8 ff ff       	call   424 <tsleep>
	} 
	lock_release(&s->lock); 
 b98:	8b 45 08             	mov    0x8(%ebp),%eax
 b9b:	89 04 24             	mov    %eax,(%esp)
 b9e:	e8 78 fd ff ff       	call   91b <lock_release>
}
 ba3:	c9                   	leave  
 ba4:	c3                   	ret    
...
void sem_init(struct Semaphore *s, int size){
 ...
 c03:	e8 e6 fc ff ff       	call   8ee <lock_init>
	s->count = size; 
 ...
 c1a:	e8 11 fe ff ff       	call   a30 <init_q>
}
 c1f:	c9                   	leave  
 c20:	c3                   	ret    
