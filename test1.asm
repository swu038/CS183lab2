...
int main(int argc, char *argv[]){
  ...
  3c:	c7 44 24 04 a1 0d 00 	movl   $0xda1,0x4(%esp)
  43:	00 
  ...
  72:	75 19                	jne    8d <main+0x8d>
            printf(1,"thread_create fails\n");
  74:	c7 44 24 04 a1 0d 00 	movl   $0xda1,0x4(%esp)
  7b:	00 
  ...
  aa:	75 19                	jne    c5 <main+0xc5>
            printf(1,"thread_create fails\n");
  ac:	c7 44 24 04 a1 0d 00 	movl   $0xda1,0x4(%esp)
  b3:	00 
  ...
  e2:	75 19                	jne    fd <main+0xfd>
            printf(1,"thread_create fails\n");
  e4:	c7 44 24 04 a1 0d 00 	movl   $0xda1,0x4(%esp)
  eb:	00 
 ...
 11a:	75 19                	jne    135 <main+0x135>
            printf(1,"thread_create fails\n");
 11c:	c7 44 24 04 a1 0d 00 	movl   $0xda1,0x4(%esp)
 123:	00 
 ...
 13e:	a1 1c 0e 00 00       	mov    0xe1c,%eax
 143:	89 44 24 08          	mov    %eax,0x8(%esp)
 147:	c7 44 24 04 b6 0d 00 	movl   $0xdb6,0x4(%esp)
 14e:	00 
 ...
 188:	75 19                	jne    1a3 <main+0x1a3>
            printf(1,"thread_create fails\n");
 18a:	c7 44 24 04 a1 0d 00 	movl   $0xda1,0x4(%esp)
 191:	00 
 ...
 1c0:	75 19                	jne    1db <main+0x1db>
            printf(1,"thread_create fails\n");
 1c2:	c7 44 24 04 a1 0d 00 	movl   $0xda1,0x4(%esp)
 1c9:	00 
 ...
 1f8:	75 19                	jne    213 <main+0x213>
            printf(1,"thread_create fails\n");
 1fa:	c7 44 24 04 a1 0d 00 	movl   $0xda1,0x4(%esp)
 201:	00 
 ...
 230:	75 19                	jne    24b <main+0x24b>
            printf(1,"thread_create fails\n");
 232:	c7 44 24 04 a1 0d 00 	movl   $0xda1,0x4(%esp)
 239:	00 
 ...
 254:	a1 1c 0e 00 00       	mov    0xe1c,%eax
 259:	89 44 24 08          	mov    %eax,0x8(%esp)
 25d:	c7 44 24 04 ce 0d 00 	movl   $0xdce,0x4(%esp)
 264:	00 
...
//    printf(1,"\n n = %d\n",n);
    n++;
 27c:	a1 1c 0e 00 00       	mov    0xe1c,%eax
 281:	83 c0 01             	add    $0x1,%eax
 284:	a3 1c 0e 00 00       	mov    %eax,0xe1c
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 626:	0f b6 80 20 0e 00 00 	movzbl 0xe20(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 784:	75 27                	jne    7ad <printf+0x120>
          s = "(null)";
 786:	c7 45 e4 e7 0d 00 00 	movl   $0xde7,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 853:	a1 40 0e 00 00       	mov    0xe40,%eax
...
free(void *ap)
{
 ...
 914:	a3 40 0e 00 00       	mov    %eax,0xe40
}
 919:	c9                   	leave  
 91a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 967:	e8 d8 fe ff ff       	call   844 <free>
  return freep;
 96c:	a1 40 0e 00 00       	mov    0xe40,%eax
}
 971:	c9                   	leave  
 972:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 985:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 988:	a1 40 0e 00 00       	mov    0xe40,%eax
 98d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 990:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 994:	75 23                	jne    9b9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 996:	c7 45 f0 38 0e 00 00 	movl   $0xe38,-0x10(%ebp)
 99d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 9a0:	a3 40 0e 00 00       	mov    %eax,0xe40
 9a5:	a1 40 0e 00 00       	mov    0xe40,%eax
 9aa:	a3 38 0e 00 00       	mov    %eax,0xe38
    base.s.size = 0;
 9af:	c7 05 3c 0e 00 00 00 	movl   $0x0,0xe3c
 9b6:	00 00 00 
  }
 ...
 a0c:	a3 40 0e 00 00       	mov    %eax,0xe40
      return (void*)(p + 1);
 ...
 a17:	eb 38                	jmp    a51 <malloc+0xde>
    ...
    if(p == freep)
 a19:	a1 40 0e 00 00       	mov    0xe40,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 af8:	c7 44 24 04 ee 0d 00 	movl   $0xdee,0x4(%esp)
 aff:	00 
 ...
 b3d:	c7 44 24 04 fc 0d 00 	movl   $0xdfc,0x4(%esp)
 b44:	00 
 ...
 b69:	c7 44 24 04 09 0e 00 	movl   $0xe09,0x4(%esp)
 b70:	00 
...
int random(int max){
 ...
 b87:	a1 34 0e 00 00       	mov    0xe34,%eax
 b8c:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 b92:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 b97:	a3 34 0e 00 00       	mov    %eax,0xe34
    return (int)(rands % max);
 b9c:	a1 34 0e 00 00       	mov    0xe34,%eax
...
void sem_acquire(struct Semaphore *s) 
{
 ...
 cd4:	e8 a3 fd ff ff       	call   a7c <lock_acquire>
	if( s->count-- < 0) 
 cd9:	8b 45 08             	mov    0x8(%ebp),%eax
 cdc:	8b 40 04             	mov    0x4(%eax),%eax
 cdf:	89 c2                	mov    %eax,%edx
 ce1:	c1 ea 1f             	shr    $0x1f,%edx
 ce4:	8d 48 ff             	lea    -0x1(%eax),%ecx
 ce7:	8b 45 08             	mov    0x8(%ebp),%eax
 cea:	89 48 04             	mov    %ecx,0x4(%eax)
 ced:	84 d2                	test   %dl,%dl
 cef:	74 27                	je     d18 <sem_acquire+0x50>
	{
		add_q(&s->q, getpid()); 
 cf1:	e8 7e f8 ff ff       	call   574 <getpid>
 cf6:	8b 55 08             	mov    0x8(%ebp),%edx
 cf9:	83 c2 08             	add    $0x8,%edx
 cfc:	89 44 24 04          	mov    %eax,0x4(%esp)
 d00:	89 14 24             	mov    %edx,(%esp)
 d03:	e8 ca fe ff ff       	call   bd2 <add_q>
		lock_release(&s->lock); 
 d08:	8b 45 08             	mov    0x8(%ebp),%eax
 d0b:	89 04 24             	mov    %eax,(%esp)
 d0e:	e8 88 fd ff ff       	call   a9b <lock_release>
		tsleep(); 
 d13:	e8 8c f8 ff ff       	call   5a4 <tsleep>
	} 
	lock_release(&s->lock); 
 d18:	8b 45 08             	mov    0x8(%ebp),%eax
 d1b:	89 04 24             	mov    %eax,(%esp)
 d1e:	e8 78 fd ff ff       	call   a9b <lock_release>
}
 d23:	c9                   	leave  
 d24:	c3                   	ret    
...
{ 
 ...
 d31:	e8 46 fd ff ff       	call   a7c <lock_acquire>
	if( s->count++ <= 0) 
 d36:	8b 45 08             	mov    0x8(%ebp),%eax
 d39:	8b 40 04             	mov    0x4(%eax),%eax
 d3c:	85 c0                	test   %eax,%eax
 d3e:	0f 9e c2             	setle  %dl
 d41:	8d 48 01             	lea    0x1(%eax),%ecx
 d44:	8b 45 08             	mov    0x8(%ebp),%eax
 d47:	89 48 04             	mov    %ecx,0x4(%eax)
 d4a:	84 d2                	test   %dl,%dl
 d4c:	74 1c                	je     d6a <sem_signal+0x45>
	{
		int tid = pop_q(&s->q); 
 d4e:	8b 45 08             	mov    0x8(%ebp),%eax
 d51:	83 c0 08             	add    $0x8,%eax
 d54:	89 04 24             	mov    %eax,(%esp)
 d57:	e8 f0 fe ff ff       	call   c4c <pop_q>
 d5c:	89 45 f4             	mov    %eax,-0xc(%ebp)
		twakeup(tid); 
 d5f:	8b 45 f4             	mov    -0xc(%ebp),%eax
 d62:	89 04 24             	mov    %eax,(%esp)
 d65:	e8 42 f8 ff ff       	call   5ac <twakeup>
	}
	lock_release(&s->lock); 
 d6a:	8b 45 08             	mov    0x8(%ebp),%eax
 d6d:	89 04 24             	mov    %eax,(%esp)
 d70:	e8 26 fd ff ff       	call   a9b <lock_release>
} 
 d75:	c9                   	leave  
 d76:	c3                   	ret    
...
void sem_init(struct Semaphore *s, int size){
 ...
 d83:	e8 e6 fc ff ff       	call   a6e <lock_init>
	s->count = size; 
 ...
 d94:	83 c0 08             	add    $0x8,%eax
 d97:	89 04 24             	mov    %eax,(%esp)
 d9a:	e8 11 fe ff ff       	call   bb0 <init_q>
}
 d9f:	c9                   	leave  
 da0:	c3                   	ret    
