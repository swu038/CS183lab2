...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ba:	0f b6 80 68 0b 00 00 	movzbl 0xb68(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 518:	75 27                	jne    541 <printf+0x120>
          s = "(null)";
 51a:	c7 45 e4 35 0b 00 00 	movl   $0xb35,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e7:	a1 88 0b 00 00       	mov    0xb88,%eax
...
free(void *ap)
{
 ...
 6a8:	a3 88 0b 00 00       	mov    %eax,0xb88
}
 6ad:	c9                   	leave  
 6ae:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 6fb:	e8 d8 fe ff ff       	call   5d8 <free>
  return freep;
 700:	a1 88 0b 00 00       	mov    0xb88,%eax
}
 705:	c9                   	leave  
 706:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 719:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 71c:	a1 88 0b 00 00       	mov    0xb88,%eax
 721:	89 45 f0             	mov    %eax,-0x10(%ebp)
 724:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 728:	75 23                	jne    74d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 72a:	c7 45 f0 80 0b 00 00 	movl   $0xb80,-0x10(%ebp)
 731:	8b 45 f0             	mov    -0x10(%ebp),%eax
 734:	a3 88 0b 00 00       	mov    %eax,0xb88
 739:	a1 88 0b 00 00       	mov    0xb88,%eax
 73e:	a3 80 0b 00 00       	mov    %eax,0xb80
    base.s.size = 0;
 743:	c7 05 84 0b 00 00 00 	movl   $0x0,0xb84
 74a:	00 00 00 
  }
 ...
 7ab:	eb 38                	jmp    7e5 <malloc+0xde>
    ...
    if(p == freep)
 7ad:	a1 88 0b 00 00       	mov    0xb88,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 88c:	c7 44 24 04 3c 0b 00 	movl   $0xb3c,0x4(%esp)
 893:	00 
 ...
 8d1:	c7 44 24 04 4a 0b 00 	movl   $0xb4a,0x4(%esp)
 8d8:	00 
 ...
 8fd:	c7 44 24 04 57 0b 00 	movl   $0xb57,0x4(%esp)
 904:	00 
...
int random(int max){
 ...
 91b:	a1 7c 0b 00 00       	mov    0xb7c,%eax
 920:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 926:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 92b:	a3 7c 0b 00 00       	mov    %eax,0xb7c
    return (int)(rands % max);
 930:	a1 7c 0b 00 00       	mov    0xb7c,%eax
...
void sem_acquire(struct Semaphore *s) 
{
 ...
 a68:	e8 a3 fd ff ff       	call   810 <lock_acquire>
	if( s->count-- < 0) 
 a6d:	8b 45 08             	mov    0x8(%ebp),%eax
 a70:	8b 40 04             	mov    0x4(%eax),%eax
 a73:	89 c2                	mov    %eax,%edx
 a75:	c1 ea 1f             	shr    $0x1f,%edx
 a78:	8d 48 ff             	lea    -0x1(%eax),%ecx
 a7b:	8b 45 08             	mov    0x8(%ebp),%eax
 a7e:	89 48 04             	mov    %ecx,0x4(%eax)
 a81:	84 d2                	test   %dl,%dl
 a83:	74 27                	je     aac <sem_acquire+0x50>
	{
		add_q(&s->q, getpid()); 
 a85:	e8 7e f8 ff ff       	call   308 <getpid>
 a8a:	8b 55 08             	mov    0x8(%ebp),%edx
 a8d:	83 c2 08             	add    $0x8,%edx
 a90:	89 44 24 04          	mov    %eax,0x4(%esp)
 a94:	89 14 24             	mov    %edx,(%esp)
 a97:	e8 ca fe ff ff       	call   966 <add_q>
		lock_release(&s->lock); 
 a9c:	8b 45 08             	mov    0x8(%ebp),%eax
 a9f:	89 04 24             	mov    %eax,(%esp)
 aa2:	e8 88 fd ff ff       	call   82f <lock_release>
		tsleep(); 
 aa7:	e8 8c f8 ff ff       	call   338 <tsleep>
	} 
	lock_release(&s->lock); 
 aac:	8b 45 08             	mov    0x8(%ebp),%eax
 aaf:	89 04 24             	mov    %eax,(%esp)
 ab2:	e8 78 fd ff ff       	call   82f <lock_release>
}
 ab7:	c9                   	leave  
 ab8:	c3                   	ret    
