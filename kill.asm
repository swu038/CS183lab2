...
main(int argc, char **argv)
{
  ...
  if(argc < 1){
   ...
   f:	c7 44 24 04 75 0b 00 	movl   $0xb75,0x4(%esp)
  16:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fa:	0f b6 80 bc 0b 00 00 	movzbl 0xbbc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 558:	75 27                	jne    581 <printf+0x120>
          s = "(null)";
 55a:	c7 45 e4 89 0b 00 00 	movl   $0xb89,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 627:	a1 dc 0b 00 00       	mov    0xbdc,%eax
...
free(void *ap)
{
 ...
 6e8:	a3 dc 0b 00 00       	mov    %eax,0xbdc
}
 6ed:	c9                   	leave  
 6ee:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 73b:	e8 d8 fe ff ff       	call   618 <free>
  return freep;
 740:	a1 dc 0b 00 00       	mov    0xbdc,%eax
}
 745:	c9                   	leave  
 746:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 759:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 75c:	a1 dc 0b 00 00       	mov    0xbdc,%eax
 761:	89 45 f0             	mov    %eax,-0x10(%ebp)
 764:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 768:	75 23                	jne    78d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 76a:	c7 45 f0 d4 0b 00 00 	movl   $0xbd4,-0x10(%ebp)
 771:	8b 45 f0             	mov    -0x10(%ebp),%eax
 774:	a3 dc 0b 00 00       	mov    %eax,0xbdc
 779:	a1 dc 0b 00 00       	mov    0xbdc,%eax
 77e:	a3 d4 0b 00 00       	mov    %eax,0xbd4
    base.s.size = 0;
 783:	c7 05 d8 0b 00 00 00 	movl   $0x0,0xbd8
 78a:	00 00 00 
  }
 ...
 7e0:	a3 dc 0b 00 00       	mov    %eax,0xbdc
      return (void*)(p + 1);
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8cc:	c7 44 24 04 90 0b 00 	movl   $0xb90,0x4(%esp)
 8d3:	00 
 ...
 911:	c7 44 24 04 9e 0b 00 	movl   $0xb9e,0x4(%esp)
 918:	00 
 ...
 93d:	c7 44 24 04 ab 0b 00 	movl   $0xbab,0x4(%esp)
 944:	00 
...
int random(int max){
 ...
 95b:	a1 d0 0b 00 00       	mov    0xbd0,%eax
 960:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 966:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 96b:	a3 d0 0b 00 00       	mov    %eax,0xbd0
    return (int)(rands % max);
 970:	a1 d0 0b 00 00       	mov    0xbd0,%eax
...
void sem_acquire(struct Semaphore *s) 
{
 ...
 aa8:	e8 a3 fd ff ff       	call   850 <lock_acquire>
	if( s->count-- < 0) 
 aad:	8b 45 08             	mov    0x8(%ebp),%eax
 ab0:	8b 40 04             	mov    0x4(%eax),%eax
 ab3:	89 c2                	mov    %eax,%edx
 ab5:	c1 ea 1f             	shr    $0x1f,%edx
 ab8:	8d 48 ff             	lea    -0x1(%eax),%ecx
 abb:	8b 45 08             	mov    0x8(%ebp),%eax
 abe:	89 48 04             	mov    %ecx,0x4(%eax)
 ac1:	84 d2                	test   %dl,%dl
 ac3:	74 27                	je     aec <sem_acquire+0x50>
	{
		add_q(&s->q, getpid()); 
 ac5:	e8 7e f8 ff ff       	call   348 <getpid>
 aca:	8b 55 08             	mov    0x8(%ebp),%edx
 acd:	83 c2 08             	add    $0x8,%edx
 ad0:	89 44 24 04          	mov    %eax,0x4(%esp)
 ad4:	89 14 24             	mov    %edx,(%esp)
 ad7:	e8 ca fe ff ff       	call   9a6 <add_q>
		lock_release(&s->lock); 
 adc:	8b 45 08             	mov    0x8(%ebp),%eax
 adf:	89 04 24             	mov    %eax,(%esp)
 ae2:	e8 88 fd ff ff       	call   86f <lock_release>
		tsleep(); 
 ae7:	e8 8c f8 ff ff       	call   378 <tsleep>
	} 
	lock_release(&s->lock); 
 aec:	8b 45 08             	mov    0x8(%ebp),%eax
 aef:	89 04 24             	mov    %eax,(%esp)
 af2:	e8 78 fd ff ff       	call   86f <lock_release>
}
 af7:	c9                   	leave  
 af8:	c3                   	ret    
...
void sem_init(struct Semaphore *s, int size){
 ...
 b57:	e8 e6 fc ff ff       	call   842 <lock_init>
	s->count = size; 
 ...
 b6e:	e8 11 fe ff ff       	call   984 <init_q>
}
 b73:	c9                   	leave  
 b74:	c3                   	ret    
