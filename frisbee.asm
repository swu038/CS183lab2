...
//    void * sp;
  ...
  1b:	c7 44 24 04 7c 0f 00 	movl   $0xf7c,0x4(%esp)
  22:	00 
 ...
 178:	c7 44 24 04 91 0f 00 	movl   $0xf91,0x4(%esp)
 17f:	00 
 ...
 195:	c7 44 24 04 a6 0f 00 	movl   $0xfa6,0x4(%esp)
 19c:	00 
 ...
 1cf:	c7 44 24 04 ba 0f 00 	movl   $0xfba,0x4(%esp)
 1d6:	00 
...
//    sleep(5);
 ...
 23e:	c7 44 24 04 d0 0f 00 	movl   $0xfd0,0x4(%esp)
 245:	00 
...
void pass_next(void *arg){
 ...
 321:	c7 44 24 04 f8 0f 00 	movl   $0xff8,0x4(%esp)
 328:	00 
...
leaving: 
 ...
 3a9:	c7 44 24 04 44 10 00 	movl   $0x1044,0x4(%esp)
 3b0:	00 
 ...
 3f7:	c7 44 24 04 10 10 00 	movl   $0x1010,0x4(%esp)
 3fe:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 7fe:	0f b6 80 90 10 00 00 	movzbl 0x1090(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 95c:	75 27                	jne    985 <printf+0x120>
          s = "(null)";
 95e:	c7 45 e4 5b 10 00 00 	movl   $0x105b,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 a2b:	a1 d4 10 00 00       	mov    0x10d4,%eax
...
free(void *ap)
{
 ...
 aec:	a3 d4 10 00 00       	mov    %eax,0x10d4
}
 af1:	c9                   	leave  
 af2:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 b3f:	e8 d8 fe ff ff       	call   a1c <free>
  return freep;
 b44:	a1 d4 10 00 00       	mov    0x10d4,%eax
}
 b49:	c9                   	leave  
 b4a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 b5d:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 b60:	a1 d4 10 00 00       	mov    0x10d4,%eax
 b65:	89 45 f0             	mov    %eax,-0x10(%ebp)
 b68:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 b6c:	75 23                	jne    b91 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 b6e:	c7 45 f0 cc 10 00 00 	movl   $0x10cc,-0x10(%ebp)
 b75:	8b 45 f0             	mov    -0x10(%ebp),%eax
 b78:	a3 d4 10 00 00       	mov    %eax,0x10d4
 b7d:	a1 d4 10 00 00       	mov    0x10d4,%eax
 b82:	a3 cc 10 00 00       	mov    %eax,0x10cc
    base.s.size = 0;
 b87:	c7 05 d0 10 00 00 00 	movl   $0x0,0x10d0
 b8e:	00 00 00 
  }
 ...
 be4:	a3 d4 10 00 00       	mov    %eax,0x10d4
      return (void*)(p + 1);
 ...
 bef:	eb 38                	jmp    c29 <malloc+0xde>
    ...
    if(p == freep)
 bf1:	a1 d4 10 00 00       	mov    0x10d4,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 cd0:	c7 44 24 04 62 10 00 	movl   $0x1062,0x4(%esp)
 cd7:	00 
 ...
 d15:	c7 44 24 04 70 10 00 	movl   $0x1070,0x4(%esp)
 d1c:	00 
 ...
 d41:	c7 44 24 04 7d 10 00 	movl   $0x107d,0x4(%esp)
 d48:	00 
...
int random(int max){
 ...
 d5f:	a1 a4 10 00 00       	mov    0x10a4,%eax
 d64:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 d6a:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 d6f:	a3 a4 10 00 00       	mov    %eax,0x10a4
    return (int)(rands % max);
 d74:	a1 a4 10 00 00       	mov    0x10a4,%eax
...
void sem_acquire(struct Semaphore *s) 
{
 ...
 eac:	e8 a3 fd ff ff       	call   c54 <lock_acquire>
	if( s->count-- < 0) 
 eb1:	8b 45 08             	mov    0x8(%ebp),%eax
 eb4:	8b 40 04             	mov    0x4(%eax),%eax
 eb7:	89 c2                	mov    %eax,%edx
 eb9:	c1 ea 1f             	shr    $0x1f,%edx
 ebc:	8d 48 ff             	lea    -0x1(%eax),%ecx
 ebf:	8b 45 08             	mov    0x8(%ebp),%eax
 ec2:	89 48 04             	mov    %ecx,0x4(%eax)
 ec5:	84 d2                	test   %dl,%dl
 ec7:	74 27                	je     ef0 <sem_acquire+0x50>
	{
		add_q(&s->q, getpid()); 
 ec9:	e8 7e f8 ff ff       	call   74c <getpid>
 ece:	8b 55 08             	mov    0x8(%ebp),%edx
 ed1:	83 c2 08             	add    $0x8,%edx
 ed4:	89 44 24 04          	mov    %eax,0x4(%esp)
 ed8:	89 14 24             	mov    %edx,(%esp)
 edb:	e8 ca fe ff ff       	call   daa <add_q>
		lock_release(&s->lock); 
 ee0:	8b 45 08             	mov    0x8(%ebp),%eax
 ee3:	89 04 24             	mov    %eax,(%esp)
 ee6:	e8 88 fd ff ff       	call   c73 <lock_release>
		tsleep(); 
 eeb:	e8 8c f8 ff ff       	call   77c <tsleep>
	} 
	lock_release(&s->lock); 
 ef0:	8b 45 08             	mov    0x8(%ebp),%eax
 ef3:	89 04 24             	mov    %eax,(%esp)
 ef6:	e8 78 fd ff ff       	call   c73 <lock_release>
}
 efb:	c9                   	leave  
 efc:	c3                   	ret    
...
{ 
 ...
 f09:	e8 46 fd ff ff       	call   c54 <lock_acquire>
	if( s->count++ <= 0) 
 f0e:	8b 45 08             	mov    0x8(%ebp),%eax
 f11:	8b 40 04             	mov    0x4(%eax),%eax
 f14:	85 c0                	test   %eax,%eax
 f16:	0f 9e c2             	setle  %dl
 f19:	8d 48 01             	lea    0x1(%eax),%ecx
 f1c:	8b 45 08             	mov    0x8(%ebp),%eax
 f1f:	89 48 04             	mov    %ecx,0x4(%eax)
 f22:	84 d2                	test   %dl,%dl
 f24:	74 1c                	je     f42 <sem_signal+0x45>
	{
		int tid = pop_q(&s->q); 
 f26:	8b 45 08             	mov    0x8(%ebp),%eax
 f29:	83 c0 08             	add    $0x8,%eax
 f2c:	89 04 24             	mov    %eax,(%esp)
 f2f:	e8 f0 fe ff ff       	call   e24 <pop_q>
 f34:	89 45 f4             	mov    %eax,-0xc(%ebp)
		twakeup(tid); 
 f37:	8b 45 f4             	mov    -0xc(%ebp),%eax
 f3a:	89 04 24             	mov    %eax,(%esp)
 f3d:	e8 42 f8 ff ff       	call   784 <twakeup>
	}
	lock_release(&s->lock); 
 f42:	8b 45 08             	mov    0x8(%ebp),%eax
 f45:	89 04 24             	mov    %eax,(%esp)
 f48:	e8 26 fd ff ff       	call   c73 <lock_release>
} 
 f4d:	c9                   	leave  
 f4e:	c3                   	ret    
