    ...
    1060:	e8 13 03 00 00       	call   1378 <exit>
{
  ...
  if(n == N){
    ...
    1085:	00 
    1086:	c7 44 24 04 4c 14 00 	movl   $0x144c,0x4(%esp)
    108d:	00 
  ...
  for(; n > 0; n--){
    ...
    10a8:	c7 44 24 04 6b 14 00 	movl   $0x146b,0x4(%esp)
    10af:	00 
  ...
  if(wait() != -1){
    ...
    10d5:	c7 44 24 04 7f 14 00 	movl   $0x147f,0x4(%esp)
    10dc:	00 
  ...
  printf(1, "fork test OK\n");
    10ee:	c7 44 24 04 92 14 00 	movl   $0x1492,0x4(%esp)
    10f5:	00 
