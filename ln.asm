...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
   ...
   f:	c7 44 24 04 8d 0b 00 	movl   $0xb8d,0x4(%esp)
  16:	00 
  ...
  60:	c7 44 24 04 a0 0b 00 	movl   $0xba0,0x4(%esp)
  67:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 412:	0f b6 80 e8 0b 00 00 	movzbl 0xbe8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 570:	75 27                	jne    599 <printf+0x120>
          s = "(null)";
 572:	c7 45 e4 b4 0b 00 00 	movl   $0xbb4,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 63f:	a1 08 0c 00 00       	mov    0xc08,%eax
...
free(void *ap)
{
 ...
 700:	a3 08 0c 00 00       	mov    %eax,0xc08
}
 705:	c9                   	leave  
 706:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 753:	e8 d8 fe ff ff       	call   630 <free>
  return freep;
 758:	a1 08 0c 00 00       	mov    0xc08,%eax
}
 75d:	c9                   	leave  
 75e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 771:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 774:	a1 08 0c 00 00       	mov    0xc08,%eax
 779:	89 45 f0             	mov    %eax,-0x10(%ebp)
 77c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 780:	75 23                	jne    7a5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 782:	c7 45 f0 00 0c 00 00 	movl   $0xc00,-0x10(%ebp)
 789:	8b 45 f0             	mov    -0x10(%ebp),%eax
 78c:	a3 08 0c 00 00       	mov    %eax,0xc08
 791:	a1 08 0c 00 00       	mov    0xc08,%eax
 796:	a3 00 0c 00 00       	mov    %eax,0xc00
    base.s.size = 0;
 79b:	c7 05 04 0c 00 00 00 	movl   $0x0,0xc04
 7a2:	00 00 00 
  }
 ...
 803:	eb 38                	jmp    83d <malloc+0xde>
    ...
    if(p == freep)
 805:	a1 08 0c 00 00       	mov    0xc08,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
 ...
 8e4:	c7 44 24 04 bb 0b 00 	movl   $0xbbb,0x4(%esp)
 8eb:	00 
 ...
 929:	c7 44 24 04 c9 0b 00 	movl   $0xbc9,0x4(%esp)
 930:	00 
 ...
 955:	c7 44 24 04 d6 0b 00 	movl   $0xbd6,0x4(%esp)
 95c:	00 
...
int random(int max){
 ...
 973:	a1 fc 0b 00 00       	mov    0xbfc,%eax
 978:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
 97e:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
 983:	a3 fc 0b 00 00       	mov    %eax,0xbfc
    return (int)(rands % max);
 988:	a1 fc 0b 00 00       	mov    0xbfc,%eax
...
void sem_acquire(struct Semaphore *s) 
{
 ...
 ab7:	83 ec 18             	sub    $0x18,%esp
	lock_acquire(&s->lock); 
 aba:	8b 45 08             	mov    0x8(%ebp),%eax
 abd:	89 04 24             	mov    %eax,(%esp)
 ac0:	e8 a3 fd ff ff       	call   868 <lock_acquire>
	if( s->count-- < 0) 
 ac5:	8b 45 08             	mov    0x8(%ebp),%eax
 ac8:	8b 40 04             	mov    0x4(%eax),%eax
 acb:	89 c2                	mov    %eax,%edx
 acd:	c1 ea 1f             	shr    $0x1f,%edx
 ad0:	8d 48 ff             	lea    -0x1(%eax),%ecx
 ad3:	8b 45 08             	mov    0x8(%ebp),%eax
 ad6:	89 48 04             	mov    %ecx,0x4(%eax)
 ad9:	84 d2                	test   %dl,%dl
 adb:	74 27                	je     b04 <sem_acquire+0x50>
	{
		add_q(&s->q, getpid()); 
 add:	e8 7e f8 ff ff       	call   360 <getpid>
 ae2:	8b 55 08             	mov    0x8(%ebp),%edx
 ae5:	83 c2 08             	add    $0x8,%edx
 ae8:	89 44 24 04          	mov    %eax,0x4(%esp)
 aec:	89 14 24             	mov    %edx,(%esp)
 aef:	e8 ca fe ff ff       	call   9be <add_q>
		lock_release(&s->lock); 
 af4:	8b 45 08             	mov    0x8(%ebp),%eax
 af7:	89 04 24             	mov    %eax,(%esp)
 afa:	e8 88 fd ff ff       	call   887 <lock_release>
		tsleep(); 
 aff:	e8 8c f8 ff ff       	call   390 <tsleep>
	} 
	lock_release(&s->lock); 
 b04:	8b 45 08             	mov    0x8(%ebp),%eax
 b07:	89 04 24             	mov    %eax,(%esp)
 b0a:	e8 78 fd ff ff       	call   887 <lock_release>
}
 b0f:	c9                   	leave  
 b10:	c3                   	ret    
